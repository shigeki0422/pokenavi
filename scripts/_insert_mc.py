...
MOVES = [
    ...
    # ランキングのクロール範囲を100位→200位へ広げた際に新たに必要になった4技
    ("オーバードライブ", "overdrive", "でんき", "special", 80, 100, 0, 12,
     "通常の攻撃技。"),
    ("くらいつく", "jaw-lock", "あく", "physical", 80, 100, 0, 12,
     "相手と自分をくらいつく状態にする。"),
    ("きりさく", "slash", "ノーマル", "physical", 80, 100, 0, 20,
     "きゅうしょアップ+1で攻撃する。"),
    ("たこがため", "octolock", "かくとう", "status", None, 100, 0, 16,
     "相手をにげられない状態とたこがため状態にする。"),
]
