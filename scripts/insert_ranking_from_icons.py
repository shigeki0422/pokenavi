...
CRAWLED_DATE = "2026-09-26"  # ← 実行時に変更
...
# 2026-09-11: move_00.png のヘッダーアイコンを目視確認
#   185位 スコア0.472でバクーダと誤判定。No.26だが40位(通常ライチュウ・茶)と別で、
#         黄色くサーフボード状の尻尾＝アローラライチュウ
#   174位 イキリンコが162位(グリーン)と重複 → 174位は黄色いイエロー
TARGETS["2026-09-11"] = {
    185: "アローラライチュウ",
    174: "イキリンコ(イエロー)",
}

# 2026-09-12: move_00.png のヘッダーを目視確認
#   190位 ドサイドンと誤判定 → No.571 あく単＝通常ゾロアーク
#   198位 マフィティフと誤判定 → No.83 カモネギ
#   200位 ブラッキーと誤判定 → No.678 青＝ニャオニクス(オス)
TARGETS["2026-09-12"] = {
    190: "ゾロアーク",
    198: "カモネギ",
    200: "ニャオニクス(オス)",
...
# 2026-09-14: move_00.png のヘッダーを目視確認
#   198位 ウェーニバルと誤判定(0.567) → No.706 ドラゴン単＝通常ヌメルゴン
#   75位  同じNo.706だがタイプがはがね＋ドラゴン＝ヒスイヌメルゴン
TARGETS["2026-09-14"] = {
    75: "ヒスイヌメルゴン",
    198: "ヌメルゴン",
}
...
TARGETS["2026-09-24"] = {
    200: "トリデプス",   # No.411 いわ/はがね（アイコン照合がマフィティフと誤判定）
}

TARGETS["2026-09-25"] = {}

TARGETS["2026-09-26"] = {
    53: "ハラバリー",   # No.939（ゴリランダーと誤判定）
}
