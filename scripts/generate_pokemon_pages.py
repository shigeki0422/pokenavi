...
# 振ってしまい風船が表示される等の誤りが起きていた。手書きには戻さないこと。
# 更新: python3 scripts/fetch_item_ids.py <season> scripts/item_ids.json
_ITEM_IDS_PATH = Path(__file__).parent / "item_ids.json"
_ITEM_CSS_PATH = Path(__file__).parent.parent / "public" / "images" / "items" / "item-sprite.css"
_SPRITE_SCALE = 0.375  # 64px セルを 24px で表示


def _build_item_sprite():
    if not (_ITEM_IDS_PATH.exists() and _ITEM_CSS_PATH.exists()):
        return {}
    ids = json.loads(_ITEM_IDS_PATH.read_text())
    css = _ITEM_CSS_PATH.read_text()
    pos = {a: (int(b), int(c))
           for a, b, c in re.findall(r"--item-(\d+):\s*(-?\d+)px (-?\d+)px", css)}
    out = {}
    for name, key in ids.items():
        p = pos.get(f"{int(key):04d}")
        if p:
            out[name] = (int(p[0] * _SPRITE_SCALE), int(p[1] * _SPRITE_SCALE))
    return out


ITEM_SPRITE = _build_item_sprite()
...
POKEMON_DATA = {
    ...
    "オリーヴァ": {
        "file": "arboliva", "dex": 930, "id": "0930-00",
        "types": ['くさ', 'ノーマル'],
        "stats": [78, 69, 90, 125, 109, 39],
    },
    "ストリンダー(ロー)": {
        "file": "toxtricity-low", "dex": 849, "id": "0849-01",
        "types": ['でんき', 'どく'],
        "stats": [75, 98, 70, 114, 70, 75],
    },
    "アローラペルシアン": {
        "file": "persian-alola", "dex": 53, "id": "0053-01",
        "types": ['あく'],
        "stats": [65, 60, 60, 75, 65, 115],
    },
    "プクリン": {
        "file": "wigglytuff", "dex": 40, "id": "0040-00",
        "types": ['ノーマル', 'フェアリー'],
        "stats": [140, 70, 45, 85, 50, 45],
    },
    "イキリンコ(グリーン)": {
        "file": "squawkabilly-green", "dex": 931, "id": "0931-00",
        "types": ['ノーマル', 'ひこう'],
        "stats": [82, 96, 51, 45, 51, 92],
    },
    "マフィティフ": {
        "file": "mabosstiff", "dex": 943, "id": "0943-00",
        "types": ['あく'],
        "stats": [80, 120, 90, 60, 70, 85],
    },
    "ペルシアン": {
        "file": "persian", "dex": 53, "id": "0053-00",
        "types": ['ノーマル'],
        "stats": [65, 70, 60, 65, 65, 115],
    },
    "フォクスライ": {
        "file": "thievul", "dex": 828, "id": "0828-00",
        "types": ['あく'],
        "stats": [70, 58, 58, 87, 92, 90],
    },
    "カモネギ": {
        "file": "farfetchd", "dex": 83, "id": "0083-00",
        "types": ['ノーマル', 'ひこう'],
        "stats": [52, 90, 55, 58, 62, 60],
    },
    "オトスパス": {
        "file": "grapploct", "dex": 853, "id": "0853-00",
        "types": ['かくとう'],
        "stats": [80, 118, 90, 70, 80, 42],
    },
    "ボーマンダ": {
        "file": "salamence", "dex": 373, "id": "0373-00",
        "types": ['ドラゴン', 'ひこう'],
        "stats": [95, 135, 80, 110, 80, 100],
    },
    "グソクムシャ": {
        "file": "golisopod", "dex": 768, "id": "0768-00",
        "types": ['むし', 'みず'],
        "stats": [75, 125, 140, 60, 90, 40],
    },
    "セグレイブ": {
        "file": "baxcalibur", "dex": 998, "id": "0998-00",
        "types": ['ドラゴン', 'こおり'],
        "stats": [115, 145, 92, 75, 86, 87],
    },
    "ゴリランダー": {
        "file": "rillaboom", "dex": 812, "id": "0812-00",
        "types": ['くさ'],
        "stats": [100, 125, 90, 60, 70, 85],
    },
    "エースバーン": {
        "file": "cinderace", "dex": 815, "id": "0815-00",
        "types": ['ほのお'],
        "stats": [80, 116, 75, 65, 75, 119],
    },
    "パーモット": {
        "file": "pawmot", "dex": 923, "id": "0923-00",
        "types": ['でんき', 'かくとう'],
        "stats": [70, 115, 70, 70, 60, 105],
    },
    "イエッサン(オス)": {
        "file": "indeedee", "dex": 876, "id": "0876-00",
        "types": ['エスパー', 'ノーマル'],
        "stats": [60, 65, 55, 105, 95, 95],
    },
    "マルノーム": {
        "file": "swalot", "dex": 317, "id": "0317-00",
        "types": ['どく'],
        "stats": [100, 73, 83, 73, 83, 55],
    },
    "ネギガナイト": {
        "file": "sirfetchd", "dex": 865, "id": "0865-00",
        "types": ['かくとう'],
        "stats": [62, 135, 95, 68, 82, 65],
    },
    "バチンウニ": {
        "file": "pincurchin", "dex": 871, "id": "0871-00",
        "types": ['でんき'],
        "stats": [48, 101, 95, 91, 85, 15],
    },
    "インテレオン": {
        "file": "inteleon", "dex": 818, "id": "0818-00",
        "types": ['みず'],
        "stats": [70, 85, 65, 125, 65, 120],
    },
    "イエッサン(メス)": {
        "file": "indeedee-f", "dex": 876, "id": "0876-01",
        "types": ['エスパー', 'ノーマル'],
