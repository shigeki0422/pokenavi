...
OCR_NATURES = {
    ...
    # おくびょう系（びょう→じょう/よう の誤読）
    "おくびよう": "おくびょう", "あくびょう": "おくびょう",
    "おくじょう": "おくびょう", "あくじょう": "おくびょう",
    # おっとり系（お→あ、と→さ の誤読）
    "あっさり": "おっとり", "あっとり": "おっとり",
    # うっかりや系（うっ→ラッ のカタカナ混入）
    "ラッかや": "うっかりや", "ラッかつや": "うっかりや", "ラッキャやく": "うっかりや",
    "ラッかやか": "うっかりや", "ラッかやや": "うっかりや", "ラッかんや": "うっかりや",
    "ラッきゃや": "うっかりや", "ラッキやや": "うっかりや", "ラッキャや": "うっかりや",
    "ラッキーや": "うっかりや", "ラッパやま": "うっかりや", "ラッパわり": "うっかりや",
    "ラッわりや": "うっかりや", "ラッカやや": "うっかりや", "ラッキャやく": "うっかりや",
    # おくびょう系（追加）
    "あくぎょう": "おくびょう", "あくじゃう": "おくびょう", "おくじゃく": "おくびょう",
    "おくりょう": "おくびょう", "あくりょう": "おくびょう", "あくむよう": "おくびょう",
    # ようき系（う→ろ等）
    "よっき": "ようき", "よろき": "ようき", "よわき": "ようき", "よこき": "ようき",
    "よろぎ": "ようき", "よろい": "ようき", "よろし": "ようき", "よろしい": "ようき",
    "よろしき": "ようき", "よろしく": "ようき", "よろこぶ": "ようき",
    "よろず": "ようき", "よろずき": "ようき", "よおき": "ようき", "よおう": "ようき",
    "ようきい": "ようき", "よう気": "ようき",
    # おだやか系（お→あ等）
    "あだやか": "おだやか", "あだかか": "おだやか", "あだかた": "おだやか",
    "あだかな": "おだやか", "あだかや": "おだやか", "あだたか": "おだやか",
    "あだわか": "おだやか", "あだわや": "おだやか", "あだわ": "おだやか",
    "あたたか": "おだやか", "あたたかい": "おだやか", "あたかも": "おだやか",
    "あたかや": "おだやか", "あたやか": "おだやか",
    # さみしがり系（さ→き等）
    "きみしがり": "さみしがり", "きみしぐり": "さみしがり", "きみしぐれ": "さみしがり",
    "さみしろり": "さみしがり", "きみっぽり": "さみしがり", "きみのり": "さみしがり",
    "きみはがり": "さみしがり", "きみりがり": "さみしがり", "きみりょり": "さみしがり",
    "ぎみりょり": "さみしがり", "きみしろ": "さみしがり", "きみかがり": "さみしがり",
    # なまいき系
    "なまいきい": "なまいき", "なまいきき": "なまいき", "なまいきな": "なまいき",
    "ねまいき": "なまいき", "ななまいき": "なまいき", "ままいき": "なまいき",
    # れいせい系
    "れいいき": "れいせい", "れいいけい": "れいせい", "れいいし": "れいせい",
    "れいいせい": "れいせい", "れいいろ": "れいせい", "れいいい": "れいせい",
    "れいせいれいせい": "れいせい",
    # しんちょう系
    "しんちゅう": "しんちょう", "しんちゃう": "しんちょう",
    "しんじゅう": "しんちょう", "しんちょうしんちょう": "しんちょう",
    # ずぶとい系（追加）
    "すぶとい": "ずぶとい", "すぶといい": "ずぶとい", "すぶどい": "ずぶとい",
    "ずぶといいろ": "ずぶとい", "ずぶという": "ずぶとい", "ずぶといずぶとい": "ずぶとい",
    "ずぶといぶ": "ずぶとい", "ずぶといほうまき": "ずぶとい", "ずぶといもの": "ずぶとい",
    "ずぶといー": "ずぶとい",
    # せっかち系
    "せっかちい": "せっかち", "せっかちさ": "せっかち", "せっかちし": "せっかち",
    "せっかちな": "せっかち", "せっかちせっかち": "せっかち",
    # むじゃき系（追加）
    "むじきぎ": "むじゃき", "むじきさ": "むじゃき", "むしむき": "むじゃき",
    # ひかえめ系
    "ひかめ": "ひかえめ", "ひかるめ": "ひかえめ", "びかめ": "ひかえめ",
    "ひかえめひかえめ": "ひかえめ",
    # 重複パターン
    "のんきのんき": "のんき", "わんぱくわんぱく": "わんぱく",
    "おくびょうおくびょう": "おくびょう", "うっかやや": "うっかりや", "うわやや": "うっかりや",
    # その他
    "いっぱり": "いじっぱり", "いじっぽり": "いじっぱり",
    "のてんき": "のうてんき",
    "すばやい": "おくびょう",
    "よっき": "ようき",
    "ましめ": "まじめ",
...
# タイプの組み合わせ→フォーム名（ベース名が曖昧なポケモンに適用）
FORM_BY_TYPES = {
    "ロトム": {
        frozenset(["でんき", "ほのお"]): "ヒートロトム",
        frozenset(["でんき", "みず"]): "ウォッシュロトム",
        frozenset(["でんき", "こおり"]): "フロストロトム",
        frozenset(["でんき", "ひこう"]): "スピンロトム",
        frozenset(["でんき", "くさ"]): "カットロトム",
    },
}

def resolve_partner_form(name, types):
    """タイプ情報があればフォーム違いを解決する"""
    if name not in FORM_BY_TYPES or not types:
        return name
...
RANK_OVERRIDES_BY_DATE = {
    ...
    "2026-07-01": {
        1: "ガブリアス", 2: "ミミッキュ", 3: "マスカーニャ", 4: "メタグロス", 5: "ブリジュラス",
        6: "ライチュウ", 7: "リザードン", 8: "カバルドン", 9: "アローラキュウコン", 10: "ムクホーク",
        11: "バシャーモ", 12: "アーマーガア", 13: "サザンドラ", 14: "アシレーヌ", 15: "ギャラドス",
        16: "イダイトウ(オス)", 17: "ラグラージ", 18: "マフォクシー", 19: "キラフロル", 20: "ウォッシュロトム",
        21: "カイリュー", 22: "オーロンゲ", 23: "ペリッパー", 24: "サーフゴー", 25: "クチート",
        26: "ラウドボーン", 27: "ドドゲザン", 28: "ゲッコウガ", 29: "ゲンガー", 30: "ドラミドロ",
        31: "ギルガルド", 32: "ドラパルト", 33: "ハッサム", 34: "ダイケンキ", 35: "ソウブレイズ",
        36: "ウルガモス", 37: "ミミロップ", 38: "スターミー", 39: "バイバニラ", 40: "ブラッキー",
        41: "メガニウム", 42: "フシギバナ", 43: "オオニューラ", 44: "カメックス", 45: "コノヨザル",
        46: "ルカリオ", 47: "ニンフィア", 48: "マンムー", 49: "エルフーン", 50: "ヒートロトム",
        51: "ハラバリー", 52: "ドヒドイデ", 53: "バンギラス", 54: "ピクシー", 55: "ドリュウズ",
        56: "マリルリ", 57: "ヒスイゾロアーク", 58: "フラエッテ(永遠)", 59: "ミロカロス", 60: "ユキメノコ",
        61: "クエスパトラ", 62: "メタモン", 63: "オニシズクモ", 64: "エアームド", 65: "カビゴン",
        66: "サーナイト", 67: "ジュカイン", 68: "ヤバソチャ", 69: "シビルドン", 70: "ジャローダ",
        71: "ガルーラ", 72: "エルレイド", 73: "ガオガエン", 74: "バサギリ", 75: "スコヴィラン",
        76: "ヤミラミ", 77: "グレンアルマ", 78: "イッカネズミ", 79: "ブリムオン", 80: "ペンドラー",
        81: "ズルズキン", 82: "ヤドラン", 83: "ジュペッタ", 84: "ヒスイヌメルゴン", 85: "ラフレシア",
        86: "エンペルト", 87: "ホルード", 88: "シャンデラ", 89: "ユキノオー", 90: "ビビヨン",
        91: "ポットデス", 92: "ガメノデス", 93: "ガラルヤドキング", 94: "カエンジシ", 95: "ドデカバシ",
        96: "ヒスイウインディ", 97: "ミミズズ", 98: "グライオン", 99: "ローブシン", 100: "ブリガロン",
        101: "デカヌチャン", 102: "イルカマン", 103: "シャワーズ", 104: "ウツボット", 105: "イダイトウ(メス)",
        106: "エレザード", 107: "ボスゴドラ", 108: "プテラ", 109: "ハリーマン", 110: "ヘラクロス",
        111: "ハカドッグ", 112: "サメハダー", 113: "デスバーン", 114: "マニューラ", 115: "エーフィ",
        116: "ウインディ", 117: "ガラルヤドラン", 118: "ウェーニバル", 119: "フーディン", 120: "カットロトム",
        121: "コータス", 122: "ファイアロー", 123: "ヒスイバクフーン", 124: "オーダイル", 125: "ニョロトノ",
        126: "ケンタロス:炎", 127: "ゴウカザル", 128: "デスカーン", 129: "チルタリス", 130: "ジュナイパー",
        131: "ランクルス", 132: "エンニュート", 133: "ルガルガン(たそがれ)", 134: "グレイシア", 135: "クレッフィ",
        136: "カイロス", 137: "カラマネロ", 138: "ルチャブル", 139: "バンバドロ", 140: "スピアー",
        141: "ハガネール", 142: "チリーン", 143: "ドダイトス", 144: "ワルビアル", 145: "ケケンカニ",
        146: "キョジオーン", 147: "サンダース", 148: "ミカルゲ", 149: "ヌメルゴン", 150: "オンバーン",
        151: "カイリキー", 152: "アリアドス", 153: "ジャラランガ", 154: "ペロリーム", 155: "デンリュウ",
        156: "アマージョ", 157: "ピジョット", 158: "ブロスター", 159: "ジジーロン", 160: "ムシャーナ",
        161: "オニゴーリ", 162: "ヤドキング", 163: "ゾロアーク", 164: "アマルルガ", 165: "カミツオロチ",
        166: "ゴルーグ", 167: "フォレトス", 168: "キュウコン", 169: "チャーレム", 170: "タイレーツ",
        171: "モルペコ", 172: "オーロット", 173: "ドサイドン", 174: "ニャオニクス(オス)", 175: "リキキリン",
        176: "アブソル", 177: "ヘルガー", 178: "エンブオー", 179: "クレベース", 180: "マッギョ",
        181: "ピカチュウ", 182: "サダイジャ", 183: "バリコオル", 184: "マホイップ", 185: "ケンタロス:水",
        186: "リーフィア", 187: "ロズレイド", 188: "ライボルト", 189: "エモンガ", 190: "フロストロトム",
        191: "ガチゴラス", 192: "バクーダ", 193: "バクフーン", 194: "ヒスイクレベース", 195: "トリデプス",
        196: "ドクロッグ", 197: "ブースター", 198: "パンプジン(ちゅうだましゅ)", 199: "アーボック", 200: "ゴロンダ",
    },
    "2026-06-22": {
    ...
    "2026-08-10": {
        15:  "イダイトウ(メス)",       # OCR=イダイトウ(オス)→赤スプライトはメス
        27:  "ウォッシュロトム",       # OCR=ロトム（みず）
        36:  "アローラキュウコン",     # OCR=キュウコン（こおり/フェアリー）
        58:  "ヒートロトム",           # OCR=ロトム（ほのお）
        59:  "ヒスイゾロアーク",       # OCR=ゾロアーク（ノーマル/ゴースト）
        69:  "ヒスイヌメルゴン",       # OCR=ヌメルゴン（ドラゴン/エスパー）
        89:  "ガラルヤドキング",       # OCR=ヤドキング（エスパー/フェアリー）
        97:  "ヒスイウインディ",       # OCR=ウインディ（ほのお/ノーマル）
        121: "ガラルヤドラン",         # OCR=ヤドラン（エスパー/フェアリー）
        134: "カットロトム",           # OCR=ロトム（でんき/くさ）
        142: "ヒスイバクフーン",       # OCR=バクフーン（ほのお/ゴースト）
        112: "ケンタロス:炎",          # OCR=ケンタロス（かくとう/ほのお）
        120: "ヒスイジュナイパー",     # OCR=ジュナイパー（くさ/ゴースト）
        176: "ケンタロス:水",          # OCR=ゲンタロス（かくとう/みず）
        192: "ヒスイクレベース",       # OCR=クレベース（こおり/ノーマル）
        197: "パンプジン(ギガだましゅ)", # OCR=パンプジン
        199: "ニャオニクス(オス)",     # OCR=ニャオニクス（青スプライト）
    },
}
...
def main():
    ...
    for rank in sorted(all_data.keys()):
        ...
        if pokemon in pokemon_to_first_rank:
            ...
            crawl_dir = f"/Users/shigeki/work/pokenavi/crawl_data/champ_crawl_{CRAWLED_DATE}"
    ...
    for rank, pokemon, rec in candidates:
        conn.execute(
            ...
            (SEASON,"single",rank,pokemon,"champions_adb",CRAWLED_DATE,now)
        )
    ...
    for rank in sorted(all_data.keys()):
        ...
        partner_names_corrected = [resolve_partner_form(OCR_POKEMON.get(pt["name"], pt["name"]), pt.get("types", [])) for pt in rec.get("partners", [])]
            ...
            if top_move_rate < 10:
                ...
                for i, m in enumerate(moves, 1):
                    ...
                    conn.execute(
                        ...
                        (SEASON,"single",pokemon,i,name,m["rate"],"champions_adb",CRAWLED_DATE,now)
                    )
            ...
            if top_item_rate < 10:
                ...
                for i, it in enumerate(items, 1):
                    ...
                    conn.execute(
                        ...
                        (SEASON,"single",pokemon,i,name,it["rate"],"champions_adb",CRAWLED_DATE,now)
                    )
            ...
            if top_ab_rate < 10:
                ...
                for i, ab in enumerate(abilities, 1):
                    ...
                    conn.execute(
                        ...
                        (SEASON,"single",pokemon,i,name,ab["rate"],"champions_adb",CRAWLED_DATE,now)
                    )
        ...
        if natures:
            ...
            if top_na_rate < 10:
                ...
                for i, na in enumerate(natures, 1):
                    ...
                    if nat not in VALID_NATURES:
                        print(f"  [SKIP_NATURE] {pokemon} rank={rank}: 未知の性格名 '{na['name']}' → '{nat}' スキップ")
                        continue
                    conn.execute(
                        "INSERT OR IGNORE INTO pokemon_natures(season,rule,pokemon,rank,nature,usage_rate,source,crawled_date,crawled_at) VALUES(?,?,?,?,?,?,?,?,?)",
                        (SEASON,"single",pokemon,i,nat,na["rate"],"champions_adb",CRAWLED_DATE,now)
                    )
            ...
            if top_ev_rate < 5:
                ...
                for i, ev in enumerate(evs, 1):
                    ...
                    conn.execute(
                        ...
                        (SEASON,"single",pokemon,i,spread,h,a,b,c,d,s,
        ...
        for i, pt in enumerate(rec.get("partners", []), 1):
            ...
            pname = resolve_partner_form(pname, pt.get("types", []))
            ...
            conn.execute(
                ...
                (SEASON,"single",pokemon,i,pname,"champions_adb",CRAWLED_DATE,now)
            )
