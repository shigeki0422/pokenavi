...
M-4で最多EVになったH32-B32-D2型。わんぱくのB↑補正と合わせてB187を確保し、環境上位のメタグロス（4位）が採用するサイコファング94.7%・バレットパンチ92.4%の物理打点を安定して受けられます。
...
H215 / A132 / B187 / D94 / S67。ふきとばし採用時はつるぎのまいを積んだミミッキュ（同居1位）やガブリアス（使用率1位）のつるぎのまい29.2%を流す対策として機能します。
...
M-3まで最多だったH32-B2-D32型。D124とわんぱくのB154を確保しつつ、特殊方向も拾える構成。
...
メタグロス（使用率4位、メガストーン採用率ほぼ100%）の主力技採用率はサイコファング94.7%・バレットパンチ92.4%と物理技が主流です。D32型（B154）でも受けられますが、B32型（B187）はさらに33ポイント高い物理耐久を確保します。また同居率2位でカバルドンと同パーティに入る頻度が高く、選出された際に物理技主体のメタグロスと向き合うケースが多いことが、B方向への投資が増えた背景と考えられます。
...
<tr>
  <td style="padding:8px 12px;border:1px solid #cbd5e1">
    <img src="/images/pokemon/pokemon-0908-00.webp" alt="マスカーニャ" style="width:36px;height:36px;vertical-align:middle;margin-right:6px">マスカーニャ（7位）
  </td>
...
<tr style="background:#fafafa">
  ...
  <td style="padding:8px 12px;border:1px solid #cbd5e1">うたかたのアリア（88.2%）のみず×2で継続的に削られる。じしんはみず/フェアリー複合に等倍で有効打にはなるが、みず技の回復がなまけるを上回る局面が多い</td>
</tr>
<tr>
  <td style="padding:8px 12px;border:1px solid #cbd5e1">
  ...
  <td style="padding:8px 12px;border:1px solid #cbd5e1;text-align:center">—</td>
  <td style="padding:8px 12px;border:1px solid #cbd5e1">カバルドンの主力技じしんがひこう複合で無効（×0）。たきのぼりのみず×2で弱点を突かれる。りゅうのまいで積まれると打点がなく止めにくい</td>
</tr>
</tbody>
</table>
</div>
...
**メタグロス（2位）**ははがねタイプのためマスカーニャのトリックフラワー（くさ）を半減でき、カバルドンが苦手なマスカーニャへの対抗手段を担える耐性が同居の軸です。カバルドンのじしんはメタグロスに×2で通るため、選出を分散した際にも互いの苦手相手を補完できます。

**アシレーヌ（3位・M-3：8位）**はカバルドンが苦手なポケモンとして同じ枠に登場しますが、同居率では3位に入っています。アシレーヌはカバルドンが展開した砂嵐でダメージを受けますが、カバルドンが対面できないひこう/ドラゴン複合やガブリアスへの対抗手段をパーティに加える意味で選出を分けて採用されます。

**ブリジュラス（5位）**はドラゴン/はがね複合でカバルドンのじしんが×2で通る相手ですが、はがねタイプのため砂嵐ダメージを受けません。カバルドンが不得意な特殊攻撃（りゅうせいぐん71.9%・ラスターカノン76.4%）をブリジュラスが担い、物理受けのカバルドンと特殊攻撃役のブリジュラスで役割を分担する構成です。
