---
title: 'ダイケンキ（ヒスイ）考察 M-2 使用率23位 型別採用率と立ち回り'
description: 'チャンピオンズM-2使用率23位ヒスイダイケンキを徹底解説。特性きれあじで威力1.5倍のせいなるつるぎ・ひけん・ちえなみを軸にしたAS型を解説。きあいのタスキ37%・くろいメガネ36%の持ち物事情、環境上位への相性、パーティ構成まで実データで紹介します。'
