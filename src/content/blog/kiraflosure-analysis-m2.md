...
<div class="poke-header">
  <img src="/images/pokemon/pokemon-0970-00.webp" alt="メガキラフロル" />
  <div>
    <h2 style="margin:0 0 8px">メガキラフロル</h2>
    <div class="type-row">
...
メガキラフロルは「ステルスロック要因」と「高火力特殊アタッカー」という2つの役割を同時にこなせる、**汎用性の高い二刀流ポケモン**として注目されています。
...
ステルスロックを撒いた上でそのままアタッカーとして機能するため、**1体で2役をこなせる**高いコストパフォーマンスが強みです。メガ進化後はさらに特殊火力とすばやさが大幅に向上するため、ステロ後もすぐ攻撃に転じられます。

### 理由2: パワージェム＋ヘドロウェーブ＋だいちのちからの技範囲が環境最広クラス

この3技の組み合わせはポケモンチャンピオンズのシングル環境に存在する主要なタイプのほとんどに等倍以上が取れます。

- **パワージェム（いわ）**: ひこうタイプ・ほのおタイプ・むしタイプ・こおりタイプに抜群
...
<tr style="background:#f1f5f9">
  ...
  <th style="padding:8px 12px;border:1px solid #cbd5e1">半減（×0.5以下）</th>
  <th style="padding:8px 12px;border:1px solid #cbd5e1">無効（×0）</th>
</tr>
</thead>
<tbody>
<tr>
  <td style="padding:8px 12px;border:1px solid #cbd5e1;font-weight:bold;color:#dc2626">
...
<div style="background:#fef2f2;border-left:4px solid #dc2626;padding:12px 16px;margin:12px 0;border-radius:0 6px 6px 0;font-size:0.9em">
<strong>⚠️ 最重要弱点：じめん×4倍</strong><br>
どくタイプはじめんが弱点（×2）、いわタイプもじめんが弱点（×2）です。この2タイプが重なるキラフロルはじめんに対して<strong>4倍弱点</strong>を持ちます。環境1位のガブリアスのじしんは確定1発で倒される可能性が非常に高く、キラフロルを使う上で最大の懸念点です。パーティ構成時には必ずじめん対策を用意してください。
</div>

**弱点まとめ（どく/いわの複合計算）：**

| 技タイプ | どくへの倍率 | いわへの倍率 | 合計 |
|--------|------------|------------|------|
| じめん | ×2（弱点） | ×2（弱点） | **×4（超ばつぐん）** |
| みず | ×1（等倍） | ×2（弱点） | ×2 |
| エスパー | ×2（弱点） | ×1（等倍） | ×2 |
| かくとう | ×1（等倍） | ×2（弱点） | ×2 |
| ほのお | ×1（等倍） | ×0.5（半減） | ×0.5 |
| くさ | ×0.5（半減） | ×2（弱点） | ×1（等倍・相殺） |
...
<tr style="background:#fafafa">
  ...
  <td style="padding:8px 12px;border:1px solid #cbd5e1">パワージェム / ヘドロウェーブ / だいちのちから / ステルスロック</td>
</tr>
<tr>
  <td style="padding:8px 12px;border:1px solid #cbd5e1;font-weight:bold">技構成例②</td>
  <td style="padding:8px 12px;border:1px solid #cbd5e1">パワージェム / ヘドロウェーブ / だいちのちから / ニードルガード</td>
</tr>
<tr style="background:#fafafa">
  <td style="padding:8px 12px;border:1px solid #cbd5e1;font-weight:bold">技構成例③</td>
  <td style="padding:8px 12px;border:1px solid #cbd5e1">パワージェム / ヘドロウェーブ / だいちのちから / エナジーボール</td>
</tr>
</tbody>
</table>
</div>
...
メガ進化後はとくこうとすばやさが通常から大幅に強化されます。おくびょうCS型でメガ進化することで、多くの無振りポケモンに先手を取りながら高火力技を叩き込めます。

技構成の核は**パワージェム＋ヘドロウェーブ＋だいちのちから**の3択技です。この3つが異なるタイプをカバーするため、ほとんどのポケモンに刺さる技が1つは存在します。

特に注目なのは**だいちのちから**の存在です。通常キラフロルはいわ/どくタイプなのにじめん技を覚え、しかもそれが特殊技（C依存）です。これにより同タイプのはがねタイプ（ブリジュラス等）や、じめんに弱いでんきタイプを特殊技で崩せるという稀有な特性があります。

4枠目のステルスロックは相手の後続に確実にダメージを蓄積できるため、パーティ全体の勝率を底上げします。初手でステルスロックを撒いてからそのままアタッカーとして動ける点がキラフロルの最大の強みです。

**弱み：**

- じめん×4倍という致命的な弱点があり、ガブリアスのじしんで確定1発圏内に入る可能性が高い
...
ひかえめにすることで、おくびょうより約9%とくこうが増加します。確定2発だったものが確定1発になるボーダーラインが存在するポケモン（特にD方向に厚いブリジュラスやアシレーヌなど）への削り性能が向上します。

メガ進化後のすばやさ強化により、おくびょうでなくても多くのポケモンに先手を取れる点もひかえめ採用を後押しします。

**弱み：**

おくびょう型が抜けていたポケモン（S102〜110帯）に対して同速か後手になる可能性があります。
...
<tr style="background:#fafafa">
  <td style="padding:8px 12px;border:1px solid #cbd5e1;font-weight:bold">技構成例①</td>
  <td style="padding:8px 12px;border:1px solid #cbd5e1">ステルスロック / パワージェム / ヘドロウェーブ / だいちのちから</td>
</tr>
<tr>
  <td style="padding:8px 12px;border:1px solid #cbd5e1;font-weight:bold">技構成例②</td>
  <td style="padding:8px 12px;border:1px solid #cbd5e1">ステルスロック / パワージェム / マッドショット / キラースピン</td>
</tr>
</tbody>
</table>
</div>
...
タスキ型は先発に出て**必ずステルスロックを撒く**ことを最優先とした構成です。きあいのタスキにより、仮に相手の先手攻撃が確定1発になる技だったとしても、HPを1残してステルスロックを確実に使えます。
...
<tr>
  <td style="padding:8px 12px;border:1px solid #cbd5e1;font-weight:bold">性格</td>
  <td style="padding:8px 12px;border:1px solid #cbd5e1">おだやか（とくぼう↑ / こうげき↓）</td>
</tr>
<tr style="background:#fafafa">
  <td style="padding:8px 12px;border:1px solid #cbd5e1;font-weight:bold">想定役割</td>
  <td style="padding:8px 12px;border:1px solid #cbd5e1">D強化によるアシレーヌ・フラエッテ対面の安定化</td>
</tr>
<tr>
  <td style="padding:8px 12px;border:1px solid #cbd5e1;font-weight:bold">技候補</td>
  <td style="padding:8px 12px;border:1px solid #cbd5e1">ステルスロック / パワージェム / ヘドロウェーブ / どくどく</td>
</tr>
</tbody>
</table>
</div>
...
<tr style="background:#2d6a4f;color:white">
  <th style="padding:8px 12px;border:1px solid #1b4332;text-align:left">型</th>
  <th style="padding:8px 12px;border:1px solid #1b4332;text-align:center">採用率</th>
  <th style="padding:8px 12px;border:1px solid #1b4332;text-align:left">主役割</th>
  <th style="padding:8px 12px;border:1px solid #1b4332;text-align:left">おすすめ度</th>
</tr>
</thead>
<tbody>
<tr>
  <td style="padding:8px 12px;border:1px solid #cbd5e1">おくびょうCS メガ</td>
  <td style="padding:8px 12px;border:1px solid #cbd5e1;text-align:center">約58%</td>
  <td style="padding:8px 12px;border:1px solid #cbd5e1">高速アタッカー＋ステロ</td>
  <td style="padding:8px 12px;border:1px solid #cbd5e1">★★★★★（最優先）</td>
</tr>
<tr style="background:#fafafa">
...
<tr>
  <td style="padding:8px 12px;border:1px solid #cbd5e1">
    <img src="/images/pokemon/pokemon-0445-00.webp" style="width:32px;height:32px;vertical-align:middle;margin-right:4px">ガブリアス（使用率1位）
  </td>
  <td style="padding:8px 12px;border:1px solid #cbd5e1">じしんがじめん×4倍で確定1発圏内。対面では受けられない</td>
  <td style="padding:8px 12px;border:1px solid #cbd5e1">じしんを無効化できるアーマーガアやふゆう・ひこうタイプに引いて受ける。キラフロルは直接対面させない立ち回りを徹底する</td>
</tr>
<tr style="background:#fafafa">
  <td style="padding:8px 12px;border:1px solid #cbd5e1">
...
<div class="partner-grid">
  ...
  <div class="partner-card">
    ...
    <div style="font-size:0.65rem;color:#555;margin-top:2px">ひこうタイプでガブリアスのじしんを無効化し、キラフロルの最大弱点を受けられる</div>
  </div>
  <div class="partner-card">
...
メガキラフロルを使うパーティを組む際の最重要事項は「じめん対策を必ず1体入れること」です。

1. **じめん対策（最優先）** — アーマーガア（ひこうタイプでじしん無効）を入れると、ガブリアスのじしんをアーマーガアで受けてキラフロルを守れます。アーマーガアは使用率6位の主要ポケモンであり、パーティに組み込みやすい選択肢です。
...
<thead>
<tr style="background:#2d6a4f;color:white">
  <th style="padding:8px 12px;border:1px solid #1b4332;text-align:left">強み</th>
  <th style="padding:8px 12px;border:1px solid #1b4332;text-align:left">弱み</th>
</tr>
</thead>
<tbody>
<tr>
  ...
  <td style="padding:8px 12px;border:1px solid #cbd5e1;vertical-align:top">
    <ul style="margin:0;padding-left:16px">
      <li>じめん×4倍の致命的な弱点（最重要）</li>
      <li>ガブリアス（使用率1位）のじしんで確定1発圏内</li>
      <li>みず×2、エスパー×2、かくとう×2の複数弱点</li>
      <li>メガ型はメガ枠を消費</li>
    </ul>
  </td>
</tr>
...
メガキラフロルはM-2シーズンにおける**「二刀流のスペシャリスト」**です。ステロを撒きながらそのままアタッカーとして機能できるコストパフォーマンスの高さが特徴で、広い技範囲とニードルガードにより多くの対面で有効な選択肢を持てます。

ただし、じめん×4倍という致命的な弱点は常に意識が必要です。パーティにアーマーガア等のじめん対策を確実に入れ、ガブリアスのじしんはアーマーガア等のじしん無効ポケモンに引いて受け、キラフロルを直接対面させない立ち回りが求められます。
