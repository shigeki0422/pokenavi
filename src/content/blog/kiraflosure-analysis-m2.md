...
<strong>⚠️ 最重要弱点：じめん×4倍（超危険）</strong><br>
...
メガ枠を消費しないため、パーティの別のポケモンをメガ進化させる構成に組み込みやすいのも大きな特徴です。タスキキラフロル＋メガゲンガーや、タスキキラフロル＋メガガブリアス（もし存在すれば）といった組み合わせが考えられます。
...
<tr>
  ...
  <td style="padding:8px 12px;border:1px solid #cbd5e1">じしんがじめん×4倍で確定1発圏内。絶対に対面で受けてはいけない</td>
  <td style="padding:8px 12px;border:1px solid #cbd5e1">アーマーガアやひこうタイプでガブリアスを受ける。キラフロルは絶対に直接対面させない</td>
</tr>
<tr style="background:#fafafa">
  <td style="padding:8px 12px;border:1px solid #cbd5e1">
    <img src="/images/pokemon/pokemon-0260-00.webp" style="width:32px;height:32px;vertical-align:middle;margin-right:4px">ラグラージ等みず/じめん
  </td>
