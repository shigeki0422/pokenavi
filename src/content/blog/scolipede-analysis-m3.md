---
title: 'ペンドラー考察 M-3 型別採用率と立ち回り'
description: 'チャンピオンズM-3使用率78位ペンドラーを徹底解説。かそく特性でS+1を積みながら、つるぎのまい72.2%・バトンタッチ61.9%で後続エースにS+A段階をそのまま引き継ぐバトン型と、メガ進化後のB149を活かす耐久型の採用実態を実データで解説します。'
