---
title: '【ポケモンチャンピオンズ】メガムクホーク M-3 構築・耐久調整と対策'
description: 'M-3シングルバトル12位。メガムクホークの構築・耐久調整と型別採用率（インファイト99%・ブレイブバード91%・はねやすめ91%）、特性あまのじゃくでAB同時上昇する仕組み、弱点3タイプへの対策、同居率上位の構築パターンを実データで解説します。'
