---
title: 'シビルドン考察 M-3 型別採用率と立ち回り'
description: 'チャンピオンズM-3使用率64位シビルドンを徹底解説。メガ後A145/C135の両刀火力と、じめん無効＋撃破で能力上昇するメガ特性うなぎのぼりが特徴。サンダーダイブ54.3%・ドレインパンチ53.5%・とぐろをまく49.6%・10まんボルト35.8%の採用率と型別立ち回りを解説。'
...
<div class="poke-header">
  <img src="/images/pokemon/pokemon-0604-00.webp" alt="シビルドン" />
  <div>
    <h2 style="margin:0 0 8px">シビルドン（メガシビルドン）</h2>
...
<div style="max-width:420px;margin:16px 0;font-size:0.9em">
  <div style="display:flex;align-items:center;gap:8px;padding:4px 0;margin-bottom:2px">
    <span style="width:80px;font-size:0.75em;color:#888">ステータス</span>
    <div style="flex:1"></div>
    <span style="width:32px;text-align:right;font-size:0.75em;color:#888">通常</span>
    <span style="width:40px;text-align:right;font-size:0.75em;color:#888">メガ後</span>
  </div>
  ...
  <div style="display:flex;align-items:center;gap:8px;padding:6px 0;border-bottom:1px solid #e2e8f0">
    ...
    <span style="width:40px;text-align:right;font-size:0.82em;font-weight:700;color:#059669">→145</span>
  </div>
  <div style="display:flex;align-items:center;gap:8px;padding:6px 0;border-bottom:1px solid #e2e8f0">
  ...
  <div style="display:flex;align-items:center;gap:8px;padding:6px 0;border-bottom:1px solid #e2e8f0">
    ...
    <span style="width:40px;text-align:right;font-size:0.82em;font-weight:700;color:#059669">→135</span>
  </div>
  <div style="display:flex;align-items:center;gap:8px;padding:6px 0;border-bottom:1px solid #e2e8f0">
    ...
    <span style="width:32px;text-align:right">80</span>
    <span style="width:40px;text-align:right;font-size:0.82em;font-weight:700;color:#059669">→90</span>
  </div>
  <div style="display:flex;align-items:center;gap:8px;padding:6px 0;border-bottom:1px solid #e2e8f0">
    ...
    <span style="width:40px;text-align:right;font-size:0.82em;font-weight:700;color:#059669">→80</span>
  </div>
  <div style="display:flex;align-items:center;gap:8px;padding:8px 0;font-weight:700">
    <span style="width:80px;min-width:80px;color:#555;white-space:nowrap">合計</span>
    <div style="flex:1"></div>
    <span style="width:32px;text-align:right;color:#2563eb;white-space:nowrap">515</span>
    <span style="width:40px;text-align:right;font-size:0.82em;font-weight:700;color:#059669">→615</span>
  </div>
</div>
...
<tr style="background:#1e3a5f;color:#fff">
  ...
  <th style="padding:10px 12px;border:1px solid #cbd5e1;text-align:left">主な技</th>
  <th style="padding:10px 12px;border:1px solid #cbd5e1;text-align:left">強み</th>
  <th style="padding:10px 12px;border:1px solid #cbd5e1;text-align:left">弱み</th>
</tr>
</thead>
<tbody>
<tr>
