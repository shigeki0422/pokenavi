...
<tr>
  ...
  <td style="padding:8px 12px;border:1px solid #cbd5e1">タイプ一致安定技。命中100、やけど10%</td>
</tr>
<tr style="background:#fafafa">
  ...
  <td style="padding:8px 12px;border:1px solid #cbd5e1;text-align:center"><strong style="color:#dc2626">68.0%</strong></td>
  <td style="padding:8px 12px;border:1px solid #cbd5e1">最大火力技。使用後とくこうが2段階低下</td>
</tr>
<tr>
  ...
  <td style="padding:8px 12px;border:1px solid #cbd5e1">タイプ一致・音技でみがわりを貫通</td>
</tr>
<tr style="background:#fafafa">
  ...
  <td style="padding:8px 12px;border:1px solid #cbd5e1">タイプ一致・使用後すばやさが1段階上昇</td>
</tr>
<tr>
  <td style="padding:8px 12px;border:1px solid #cbd5e1"><strong>ねっさのだいち</strong></td>
  ...
  <td style="padding:8px 12px;border:1px solid #cbd5e1">じめん技。はがね・どく補完、でんきタイプ無効対策</td>
</tr>
</tbody>
</table>
</div>
