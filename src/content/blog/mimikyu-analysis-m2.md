...
ばけのかわで弱点技1発を無効化し、その隙につるぎのまいでAを2段階上げます。いじっぱりA32（こうげき実数値約156）にA+2が乗ると、タイプ一致じゃれつくでガブリアス・カイリュー・サザンドラといったドラゴン勢を一撃圏に入れられます。ようき型と比べA実数値が約10%高く、つるぎのまい後の確定数が1つずれる相手が増えるのが、いじっぱりが8割を占める理由です。
