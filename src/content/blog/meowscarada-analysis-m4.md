...
トリックフラワー（くさ・威力70・必中・必ず急所）とトリプルアクセル（こおり・連続3回攻撃で最大威力60）が主力技。とんぼがえり（むし・威力70）は攻撃後に交代でき、こだわりスカーフの技固定デメリットを対面操作で補います。はたきおとす（あく・威力65、相手が道具を持っていると1.5倍）は相手の持ち物を落とす効果も兼ねた打点です。
