---
title: 'メガスターミー M-2【使用率20位】ちからもち実質種族値・火力指数42585と対策'
description: 'M-2使用率20位メガスターミーを解説。ちからもちで実質A200相当の火力指数42585、アクアブレイク採用率・アクアジェット先制、実質種族値とアイススピナー・クイックターンの採用率をデータで紹介。'
...
**[この構成を軸にした簡単構築を試す →](/party-suggest/mega-starmie/)**
