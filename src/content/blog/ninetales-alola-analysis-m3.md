---
title: '【ポケモンチャンピオンズ】キュウコン（アローラ）考察 M-3 使用率9位の採用理由と型別立ち回り'
description: 'M-3シングルバトルで使用率9位のアローラキュウコンを徹底分析。オーロラベール98.0%・ひかりのねんど90.5%で壁展開の軸として機能。H2-D32-S32おくびょう型の実数値・苦手な相手・パートナー構成までDBデータで解説します。'
