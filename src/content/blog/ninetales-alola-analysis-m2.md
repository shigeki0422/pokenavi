---
title: 'キュウコン（アローラ）考察 M-2 使用率52位 ゆきふらしオーロラベールの型と立ち回り'
description: 'チャンピオンズM-2使用率52位キュウコン（アローラ）を徹底解説。ゆきふらし（採用率99.7%）からのオーロラベール88.5%・必中ふぶき87.1%・フリーズドライ69.9%を軸にした補助＋特殊アタッカー型を、性格おくびょう87.3%・とけないこおり46.7%の実データと実数値計算で解説します。'
