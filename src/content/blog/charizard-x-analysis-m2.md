...
メガリザードンXのとくせい**かたいツメ**は、接触技の威力を×1.3にする効果を持ちます。フレアドライブ（威力120）がかたいツメで実質威力156、ドラゴンクロー（威力80）が実質威力104となります。さらに**りゅうのまい**で+1こうげき・+1すばやさを積めば、積み後の実質ほのお一致フレアドライブはこうげき130×1.5（タイプ一致補正）×1.3（かたいツメ）×1.5（りゅうのまい）という高い火力を叩き出します。M-2環境で猛威を振るうガブリアスやブリジュラスに対して、りゅうのまい1回から確定2発以内に持ち込めるケースが増えることで、**積みエース型の決定力としてはトップクラス**です。
...
メガリザードンXはこうげき130・とくこう130というこうげき・とくこう均等の両刀数値を持ちます。物理に偏ったAS型（りゅうのまい）だけでなく、ニトロチャージ採用のCS型や、かみなりパンチでギャラドス・アシレーヌといったみず複合をケアする混合型も成立します（みず単体ならほのお技を等倍で受けられるため、かみなりパンチは主にひこう・みず複合への上振れ打点）。相手のHB振りポケモンをとくこう技でケアできる柔軟性は、Xを「読まれにくい」アタッカーとして機能させます。
...
- **かたいツメ×りゅうのまい**の組み合わせは積み1回から全抜き射程が広がる火力
