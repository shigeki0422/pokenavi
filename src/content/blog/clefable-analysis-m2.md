---
title: 'メガピクシー考察 M-2 使用率35位 コスモパワー積みの全抜き性能と立ち回り'
description: 'チャンピオンズM-2使用率35位メガピクシーを徹底解説。フェアリー/ひこうへのタイプ変化でじめん技を無効化し、コスモパワー(55.3%)+アシストパワー(35.3%)で全抜きを狙う積みフェアリー。マジックミラーで変化技を跳ね返す耐久型の構築と苦手な相手を実データで解説します。'
