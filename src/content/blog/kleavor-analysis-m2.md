...
description: 'チャンピオンズM-2使用率63位バサギリを徹底解説。むし/いわで弱点3つのみ、きれあじ（採用率98.9%）で1.5倍のがんせきアックス（99.9%）を軸にしたA205物理アタッカー。きあいのタスキ60.8%・こだわりスカーフ29.4%の持ち物分岐と、ようき最速S150の立ち回りを実データで解説します。'
