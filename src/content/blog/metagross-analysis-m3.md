---
title: 'メガメタグロス M-3【使用率7位】S178速度ライン・技採用率と4タイプ弱点対策'
description: 'M-3使用率7位メガメタグロスを解説。メガ後S178の速度ライン、サイコファング84.2%・バレットパンチ79.1%の技採用率、ほのお・ゴースト・あく・じめん4タイプ弱点への対策をデータで紹介。'
