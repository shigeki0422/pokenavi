---
title: 'メガメタグロス M-3【使用率7位】相性補完・構築と4タイプ弱点対策'
description: 'M-3使用率7位メガメタグロスの相性補完と構築を解説。サイコファング84.2%・バレットパンチ79.1%の技採用率、S178速度ライン、ほのお・ゴースト・あく・じめん4タイプ弱点への対策と相方候補をデータで紹介。'
