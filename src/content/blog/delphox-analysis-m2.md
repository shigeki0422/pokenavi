---
title: 'メガマフォクシー M-2【使用率25位】相性補完・有利不利とわるだくみ型採用率'
description: 'チャンピオンズM-2使用率25位メガマフォクシーを解説。とくこう種族値159・すばやさ134を活かしたわるだくみ特殊エースの構成を解説。マフォクシナイト採用率96.5%、かえんほうしゃ・サイコショックの技採用率、環境上位への相性とパートナーを実データで紹介します。'
