...
スコヴィランの90.4%はスコヴィラナイトを採用し、メガ進化で特性が**とびだすハバネロ**に変わります。これは技のダメージを受けると攻撃してきた相手を**やけど状態にする**特性で、物理アタッカーがスコヴィランを殴るたびにこうげきが実質半減し、やけどの定数ダメージも加わって火力と居座り性能が落ちていきます。やどりぎ・まもる・みがわりで粘る受け型と噛み合い、殴ってくる物理アタッカーほど自滅的に弱っていくのが、メガスコヴィラン最大の差別化点です。ムラっけはメガ進化前の特性のため、メガ運用が前提の本種では、とびだすハバネロが実戦上の主役になります。
