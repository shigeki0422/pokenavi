...
<tr>
  ...
  <td style="padding:8px 12px;border:1px solid #cbd5e1">ヘドロウェーブ・シャドーボールはHD型で受け、じしんがゴースト/どくに×2（ゴースト1×どく2）で通る。ただしS110で上を取られ、きあいだま（採用率37.4%・かくとう×2）採用個体には弱点を突かれるため安定はしない</td>
</tr>
<tr style="background:#fafafa">
  <td style="padding:8px 12px;border:1px solid #cbd5e1">
