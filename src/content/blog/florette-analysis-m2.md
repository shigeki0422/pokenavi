...
すばやさを最大まで伸ばし、多くの環境ポケモンに先手を取れるようにした型。めいそうで積んでからドレインキッスで回復しつつ相手を削り、ムーンフォースで全抜きを狙います。はめつのひかりは詰め筋として採用——積み上がった後に打てば交代しても追いかけてダメージを与えられます。

**弱点**：積む前にはがね・どく技で倒されると何もできないため、メガギャラドスのいかくや先発のガブリアスでそれらを排除してから出すのが理想。
...
努力値：CS（とくこう・すばやさ全振り）
持ち物：フラエッテナイト
技構成：ムーンフォース / めいそう / ドレインキッス / サイコキネシス or はめつのひかり
```

**ポイント**

すばやさをやや犠牲にしてとくこうを最大化した型。おくびょうCSより素早さは落ちますが、めいそうを1積みした後のドレインキッスの回復量・ムーンフォースの破壊力がひとまわり大きくなります。**積む余裕がある場面では火力型の方が崩しやすい**というプレイヤーに支持されています。

4枠目に**サイコキネシス**を入れれば、フラエッテの弱点であるどくタイプ（ニドクイン・どくタイプ全般）への打点を持てる点が差別化。

**弱点**：おくびょうより遅いため、同速帯や準速の相手に抜かれるリスクがある。環境の素早さラインの把握が重要。

---

### 型③：ずぶといHB型（耐久積み・みがわりはめつのひかり）

**採用率3位（ずぶとい4.1%）**

```
性格：ずぶとい
努力値：HB+c（HP・ぼうぎょ重点、とくこうに少し振る）
持ち物：フラエッテナイト
...
物理耐久を底上げし、ルカリオ・ハッサムなどはがね物理アタッカーの攻撃を1発耐えてからめいそうを積む耐久特化型。こうごうせいで確実にHPを回復しながら長期戦に持ち込みます。

**みがわり採用**の場合は、みがわりを張った状態ではめつのひかりを発動し、みがわりに守られながら確実にダメージを蓄積する戦術が可能。ゲンガーの催眠・トリックへの耐性も大幅に向上します。

**弱点**：すばやさに振らないため、素早さ中間帯のポケモンに後手を踏む場面が増える。いかくサポートが必須。
...
| 型 | 性格 | 優先度 | おすすめ場面 |
|:--|:--:|:--|:--|
| おくびょうCS | おくびょう | 素早さ | 環境の素早さ争いに勝ちたい・先手積みを狙う |
| ひかえめCS | ひかえめ | 火力 | 積む前提で確実に崩したい・どくタイプが多い環境 |
| ずぶといHB | ずぶとい | 耐久 | 物理アタッカーが多い環境・みがわり展開を使いたい |
