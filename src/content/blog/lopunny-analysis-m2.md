...
**強み:**
- S205で、いじっぱり型（S187）では先手を取れないようきマスカーニャ（S192・使用率3位）、おくびょうメガマフォクシー（S204・25位・おくびょう採用率87%）にも先手を取れる
...
**弱み:**
- Sがようき（205）より低い187にとどまるため、ようきマスカーニャ（S192）やおくびょうメガマフォクシー（S204）に先手を取られる
- ねこだましを採用しない場合、先制で相手の行動を封じる手段がなくなる

**いじっぱり型の採用意義:**
Aがようき（188）に対していじっぱり（206）と約10%高く、ようき型では2発必要な相手を1発で倒せるケースが生まれます。特につるぎのまい後（A412相当）はその差がさらに広がります。一方で、ようきマスカーニャ（使用率3位）やおくびょうメガマフォクシー（25位）に先手を取られるリスクを受け入れる選択です。
