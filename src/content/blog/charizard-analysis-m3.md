---
title: '【ポケモンチャンピオンズ】リザードン考察 M-3 メガY型とX型の採用率と立ち回り'
description: 'M-3シングルバトルで使用率7位のリザードンを分析。メガY（リザードナイトY 75.9%）とメガX（22.6%）の型別採用率・種族値・技構成・立ち回りを解説。ひでり+ソーラービーム79.0%採用の構造から読み取れる運用思想も考察。'
