---
title: '【ポケモンチャンピオンズ】メガライチュウY M-3 使用率3位 構築とパーティ解説'
description: 'M-3シングルバトルで使用率3位のメガライチュウY構築を徹底分析。ノーガード特性でとくこう160のでんじほう96.2%・きあいだま95.5%が全技必中。おくびょうH2-C32-S32型76.8%の実データと環境上位への相性・パーティ構成を解説。'
