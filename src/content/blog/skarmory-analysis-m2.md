---
title: '【ポケモンチャンピオンズ】エアームド考察 M-2 使用率44位 物理受け・ステロ撒きの型別採用率'
description: 'M-2シングルバトルで使用率44位のエアームドを徹底分析。はがね/ひこうでじめん無効・9タイプ耐性を持つ物理受け。メガエアームド(すじがねいり)のつるぎのまい積み型と、がんじょうステロ撒き型の採用率・立ち回り・苦手な相手を実データで解説します。'
pubDate: '2026-06-04'
draft: true
---
...
シーズンM-2（2026/5/13〜6/17）のシングルバトルで、エアームドは**使用率44位**。はがね/ひこうという複合タイプにより**じめん技を無効化**し、さらに9タイプを半減する屈指の物理受けです。技構成はブレイブバード（採用率67.3%）・つるぎのまい（57.9%）・はねやすめ（56.1%）・ステルスロック（26.7%）・ふきとばし（19.4%）と、起点作りと積みアタッカーの両面を備えています。

注目すべきは**エアームドナイトの採用率66.6%**。メガエアームドは特性が**すじがねいり**（相手に交代を許さない／自分は逃げられる）に変わり、すばやさ種族値が70→110、こうげき80→140と一気に攻撃寄りへ振れます。素のエアームド（がんじょう／くだけるよろい）が受け、メガが積みアタッカーという二つの顔を使い分けられるのが、この世代のエアームドの軸です。
...
### 3. メガ化でアタッカーへ転身（すじがねいり）

メガエアームドの**すじがねいり**は相手のレッドカード・吹き飛ばし以外の交代を封じ、苦手な相手を呼んでも逃がさず詰められます。こうげき140・すばやさ110まで上がるため、つるぎのまい（57.9%）を1積みすればブレイブバードで広範囲を上から制圧できます。受けポケモンが終盤に積みアタッカーへ化けるのが強みです。
...
<tr style="background:#fafafa">
  ...
  <td style="padding:8px 12px;border:1px solid #cbd5e1">でんき・はがね・どく・いわへの打点。キラフロルに刺さる</td>
</tr>
<tr>
...
メイン打点はブレイブバード（67.3%）とつるぎのまい（57.9%）。じめん打点のドリルライナー（45.6%）は、ブレイブバードを半減するでんき・はがね・いわへの相補技として機能します。
...
メガ化でこうげき140・すばやさ110まで上がり、つるぎのまいを1積みすればブレイブバードで広範囲を上から制圧できます。すじがねいりで相手の交代を封じるため、苦手枠を引っ込められず詰めやすいのが受け型にない長所です。はねやすめで居座って積みターンを作れるため、半減タイプ相手なら起点から積み始められます。

ドリルライナーはブレイブバードを半減するでんき・はがね・いわ（キラフロル等）への相補打点。アイアンヘッドに替えればフェアリー・こおりへ刺さります。
...
メガを別枠に回し、素のぼうぎょ140＋特性**がんじょう**（採用率61.9%）で物理アタッカーを完封する受け型です。ステルスロック（26.7%）で交代ダメージを撒き、ふきとばし（19.4%）で相手の積みを流して再びステロダメージを与えられます。はねやすめで延々と居座れるため、ガブリアスのじしんやマスカーニャのトリックフラワーといった物理主体の相手に対し起点を作り続けられます。ボディプレスは素の高いぼうぎょをそのまま火力に変換できるため、HB受け型でも有効打を持てます。
...
使用率上位のうち、エアームドと相性がはっきり出るポケモンを有利・不利の両面から挙げます。じめん無効・9タイプ半減で物理を受けつつ、ほのお・でんきの2弱点が×2で通る点が相性の分かれ目です。相性はメガ前（受け）／メガ後（S110アタッカー）の両面を踏まえて判断しています。
...
<tr>
  ...
  <td style="padding:8px 12px;border:1px solid #cbd5e1">主力じしん（採用率99.2%）が無効。げきりん（48%）も×0.5。受け出して起点化でき、ドリルライナーで等倍を返せる</td>
</tr>
<tr style="background:#fafafa">
  <td style="padding:8px 12px;border:1px solid #cbd5e1">
...
<tr style="background:#fafafa">
  ...
  <td style="padding:8px 12px;border:1px solid #cbd5e1;text-align:center;color:#16a34a;font-weight:bold">○ 有利</td>
  <td style="padding:8px 12px;border:1px solid #cbd5e1">ヘドロウェーブ（どく・69%）無効、だいちのちから（67%）も無効。ドリルライナー（いわ/どくに×4）で弱点を突ける。ただしパワージェム（いわ・85%）は等倍で通る</td>
</tr>
<tr>
  <td style="padding:8px 12px;border:1px solid #cbd5e1">
  ...
  <td style="padding:8px 12px;border:1px solid #cbd5e1;text-align:center;color:#dc2626;font-weight:bold">× 不利</td>
  <td style="padding:8px 12px;border:1px solid #cbd5e1">かえんほうしゃ（42%）・フレアドライブ（33%）がこちらに×2。受けが成立せず、こちらの一致技も半減される（後述）</td>
</tr>
<tr style="background:#fafafa">
  <td style="padding:8px 12px;border:1px solid #cbd5e1">
  ...
  <td style="padding:8px 12px;border:1px solid #cbd5e1;text-align:center;color:#dc2626;font-weight:bold">× 不利</td>
  <td style="padding:8px 12px;border:1px solid #cbd5e1">パラボラチャージ（でんき・98.9%）がこちらに×2。なまける（83%）で粘られ、受けあいでも崩しきれない（後述）</td>
</tr>
</tbody>
</table>
</div>
...
<tr>
  ...
  <td style="padding:8px 12px;border:1px solid #cbd5e1">ほのお技がこちらに×2。さらにこちらのブレイブバードは半減（ひこう0.5）、ドリルライナー・アイアンヘッドもほのお/ひこうには等倍・半減で押し切れない</td>
...
<tr style="background:#fafafa">
  ...
  <td style="padding:8px 12px;border:1px solid #cbd5e1">ほのおのまい（80%）がこちらに×2。ちょうのまい（97%）の積み起点にされ、ブレイブバードは半減（むし0.5）で止められない</td>
...
<tr>
  ...
  <td style="padding:8px 12px;border:1px solid #cbd5e1">パラボラチャージ（98.9%）が×2。なまける（83%）で回復され、こちらの打点も乏しく崩せない</td>
...
<tr>
  ...
  <td style="padding:8px 12px;border:1px solid #cbd5e1">10まんボルト（57%）・ボルトチェンジ（89%）のでんき技が×2。おにび（81%）でこうげきを下げられ、メガAS型の火力も殺される</td>
...
<tr>
  ...
  <td style="padding:8px 12px;border:1px solid #cbd5e1;text-align:left;font-size:0.85em">S110＋A140で積み制圧。すじがねいりで縛れる</td>
...
エアームドははがね/ひこうでじめん・どくを無効化し、9タイプを半減する優秀な物理受けです。M-2ではエアームドナイト採用率66.6%・ようき49.5%が示す通り、素のぼうぎょ140で物理を受けてからメガ化（すじがねいり）でこうげき140・すばやさ110の積みアタッカーに転身する運用が主流になっています。
