---
title: 'メタモン考察 M-2 使用率66位 へんしんコピーの立ち回り'
description: 'チャンピオンズM-2使用率66位メタモンを徹底解説。特性かわりもの（採用率99.1%）で相手をそのままコピーする特殊なポケモンで、こだわりスカーフ82.3%でコピー後に上を取る運用が主流。種族値オール48・ノーマル単のへんしん前の弱点と、積んだエースを打ち返す立ち回りを実データで解説します。'
