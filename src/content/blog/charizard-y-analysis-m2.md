...
C159は現環境の特殊アタッカーの中でもトップクラスの数値です。とくぼう115はXの85と比べて大幅に高く、特殊受けとして後出しされる相手にも打ち合えます。一方でぼうぎょ78は低く、物理攻撃への耐性は高くありません。すばやさ100はS無振り同速グループとの戦いが発生しやすいため、**おくびょう最速かひかえめCSの選択**が重要になります。
...
<div style="background:#fee2e2;border:1px solid #fca5a5;border-radius:8px;padding:12px;margin:12px 0">
  ...
  メガリザードンYの最大の弱点は<strong>いわタイプへの4倍弱点</strong>です。ステルスロック（ステロ）が設置されている状態で登場すると、最大HPの<strong>1/2ダメージ</strong>を受けます（通常は1/4、4倍弱点は1/2）。ガブリアスのがんせきふうじ、カバルドンのステロなど、環境上位のいわ技持ちとの対面は致命的です。<strong>ステロ対策ポケモンとのセット採用が必須</strong>です。
</div>
...
<tr>
  ...
  <td style="padding:8px 12px;border:1px solid #fca5a5">がんせきふうじ（いわ）で4倍弱点。ステロ撒きも担う</td>
...
**アーマーガアが最重要パートナー**: メガリザードンYにとって最も危険なのはステロです。アーマーガアはデフォグでステロを除去でき、さらにガブリアスのじしん・がんせきふうじに対してひこうタイプで無効化・耐性を持ちます。「アーマーガアでステロを除去してからメガリザードンYを出す」という流れが基本になります。
