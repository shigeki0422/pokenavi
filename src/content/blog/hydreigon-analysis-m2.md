---
title: 'サザンドラ考察【チャンピオンズM-2 使用率21位】スカーフ型の技採用率と立ち回り'
description: 'チャンピオンズM-2使用率21位サザンドラを徹底解説。こだわりスカーフ採用率79.7%による高速性、あくのはどう98.5%・りゅうせいぐん90.2%の技構成を実データで解説。あく/ドラゴンの相性とフェアリー×4弱点、環境上位への有利・不利を網羅します。'
