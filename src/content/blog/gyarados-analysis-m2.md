---
title: 'メガギャラドス考察 M-2使用率10位 型・タイプ変化・立ち回り'
description: 'チャンピオンズM-2使用率10位メガギャラドスを徹底解説。メガ進化でみず/ひこう→みず/あくへのタイプ変化、特性かたやぶり、A155+りゅうのまいの全抜き性能、りゅうのまい積み型・ちょうはつ型の3大構築を実データで徹底解説します。'
