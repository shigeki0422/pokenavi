...
description: 'チャンピオンズM-2使用率56位ヤドキング（ガラル）を徹底解説。さいせいりょく（採用率99.6%）の交代回復、かえんほうしゃ62.5%・なまける50.0%・どくどく31.9%を軸にしたHD耐久型を実データで解説。たべのこし34.3%・オボンのみ28.6%の持ち物分岐、じめん・ゴースト・あく弱点への注意点まで網羅します。'
