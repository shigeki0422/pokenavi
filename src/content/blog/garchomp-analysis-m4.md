...
こおり×4が最大の弱点です。M-4の使用率圏内ではアローラキュウコン（16位、フリーズドライ84.4%・ふぶき71.5%）とゲッコウガ（14位、れいとうビーム87.2%）が主なこおり脅威です。フェアリー×2ではミミッキュ（2位、じゃれつく98.2%）・アシレーヌ（6位、ムーンフォース98.0%）が該当します。
...
タスキ込みで最低でも2ターン確保できる立ち位置から、設置技＋スケイルショットで動く構成。スケイルショットはミミッキュのばけのかわを初弾で剥がしてから追加ヒットを通せるため、げきりん（ばけのかわ1発消費で止まり混乱リスクあり）より対ミミッキュの処理が安定します。
...
最大の変化は**スケイルショット（+9.4pp）とげきりん（-10.7pp）の入れ替え**です。スケイルショットは威力25×2〜5回のドラゴン連続技で、最後にS+1・B-1の効果がつきます。げきりん（威力120）との比較では単発の最高打点は劣りますが、使用後の混乱が発生しない点とミミッキュのばけのかわを1発で剥がせる点が評価されています。
...
**スケイルショット（+9.4pp）とげきりん（-10.7pp）の入れ替え**：げきりん（威力120）は単発の最高打点ですが、使用後に混乱が確定するため後続の動きを縛ります。スケイルショット（威力25×2〜5回）は最後にS+1・B-1が付くため、スケイルショット後にS上昇が残ります。M-4でミミッキュが依然2位の環境では、げきりんの場合ばけのかわ1発消費で止まり混乱リスクが残るのに対し、スケイルショットは初弾でばけのかわを剥がし追加ヒットで処理できる安定性が評価されています。

**がんせきふうじの新定着（圏外→30.0%）**：がんせきふうじ（いわ・威力60・命中95・S-1効果）はM-3では採用17.2%未満で圏外でしたが、M-4で30.0%まで上昇しました。ガブリアスのじしんがひこうタイプに無効なため、相手のひこうタイプへの打点として、またこおり×4弱点を突いてくるアローラキュウコンやゲッコウガへの補助打点として、がんせきふうじが評価されていると考えられます。また4枠目の選択肢がどくづき（14.0%）よりがんせきふうじ（30.0%）に移行している点は、環境のフェアリー圧力への対処をスケイルショット（ばけのかわ剥がし）に委ねた上で、ひこう・炎への補助打点を優先したと読み取れます。

**どくづきの位置づけ**：どくづき（どく・威力80）はM-4で14.0%と圏内に新登場した技です。フェアリータイプに×2で通る打点として、どくづきを採用する約7人に1人は対フェアリーの専用打点を重視しています。アシレーヌが同居率2位に入り自パーティのフェアリー対策を担えるケースが増えた一方、対戦相手のアシレーヌを直接狙うどく打点として少数派ながら維持されています。
...
<tr>
  ...
  <td style="padding:8px 12px;border:1px solid #cbd5e1">じゃれつく（98.2%）でフェアリー×2。ばけのかわで初弾を無効にするため、スケイルショット採用でないと1ターンで処理できない。こちらのじしんは2打点の確保が必要な場面が多い</td>
</tr>
<tr style="background:#fafafa">
  <td style="padding:8px 12px;border:1px solid #cbd5e1">
    <img src="/images/pokemon/pokemon-0730-00.webp" alt="アシレーヌ" style="width:36px;height:36px;vertical-align:middle;margin-right:6px">アシレーヌ（6位）
  </td>
...
<tr style="background:#fafafa">
  <td style="padding:8px 12px;border:1px solid #cbd5e1">
    <img src="/images/pokemon/pokemon-0658-00.webp" alt="ゲッコウガ" style="width:36px;height:36px;vertical-align:middle;margin-right:6px">ゲッコウガ（14位）
  </td>
...
**ミミッキュ（1位）**は、ガブリアスが弱点を突かれやすいフェアリー・ドラゴンタイプの相手をじゃれつく・かげうちで処理できます。一方でミミッキュ自身が苦手なはがね・どくタイプは、ガブリアスのじしんが処理する役割分担です。

**アシレーヌ（2位）**はフェアリー/みずで、ガブリアスのドラゴン弱点をフェアリー技で圧迫し、相手のカバルドン（使用率3位）・メタグロス（使用率4位）のようなはがね・じめんタイプへのみず打点を持ちます。ガブリアスのじしんはアシレーヌと苦手な相手（ブリジュラス・メタグロス等）に通り、アシレーヌの担当できないじめん・どく系をガブリアスがカバーする補完関係です。

**メタグロス（3位）**ははがね/エスパーで、ガブリアスのこおり×4弱点を突くアローラキュウコンにバレットパンチ（はがね×4）が通ります。ガブリアスのじしんがメタグロスに×2で刺さる環境上位ポケモンを圧迫でき、打点範囲が補完関係にあります。

**ブリジュラス（5位）**ははがね/ドラゴンでフェアリーへの耐性を持ちます。ガブリアスが苦手なミミッキュ・アシレーヌのフェアリー技に耐性を持つため、選出段階でのフェアリー圧力を緩和できます。ブリジュラスが苦手なじめん技をガブリアスが受けることはできませんが、ガブリアスのじしんがブリジュラスに×2で通るため相手のはがねタイプへの打点を補います。
...
- **スケイルショット（+9.4pp）↔ げきりん（-10.7pp）**：使用後の混乱リスクをなくしミミッキュ対策を安定させる技入れ替え
