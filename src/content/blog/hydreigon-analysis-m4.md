...
<div style="max-width:480px;margin:16px 0;font-size:0.9em">
  <div style="display:flex;align-items:center;gap:4px;padding:5px 0;border-bottom:1px solid #e2e8f0">
    ...
    <span style="min-width:40px;text-align:right">92</span>
  </div>
  <div style="display:flex;align-items:center;gap:4px;padding:5px 0;border-bottom:1px solid #e2e8f0">
...
<strong>EV:</strong> H2-C32-S32（採用率72.0%・全型中最多）<br>
<strong>持ち物:</strong> こだわりスカーフ（84.2%）
</div>
<div>
...
ひかえめはH169 / A112 / B110 / C194 / D110 / S150（スカーフ込みS225）。C194は特殊アタッカーとして高水準の打点を出せます。

おくびょうはH169 / A112 / B110 / C177 / D110 / S165（スカーフ込みS247）。S247はスカーフ持ち同士の対面でも上を取りやすい一方、C177とひかえめよりダメージ量が落ちるトレードオフになります。
...
<tr>
  ...
  <td style="padding:8px 12px;border:1px solid #cbd5e1;text-align:center"><strong>99.3%</strong></td>
  <td style="padding:8px 12px;border:1px solid #cbd5e1;text-align:center;color:#16a34a">+0.9pp</td>
</tr>
<tr style="background:#fafafa">
  ...
  <td style="padding:8px 12px;border:1px solid #cbd5e1;text-align:center">89.6%</td>
  <td style="padding:8px 12px;border:1px solid #cbd5e1;text-align:center"><strong>93.3%</strong></td>
  <td style="padding:8px 12px;border:1px solid #cbd5e1;text-align:center;color:#16a34a">+3.7pp</td>
</tr>
<tr>
...
<tr style="background:#fafafa">
  ...
  <td style="padding:8px 12px;border:1px solid #cbd5e1;text-align:center">57.4%</td>
...
<tr>
  <td style="padding:8px 12px;border:1px solid #cbd5e1">だいもんじ</td>
  <td style="padding:8px 12px;border:1px solid #cbd5e1;text-align:center"><img src="/images/types/type-09-fire.png" alt="ほのお" style="width:28px;height:28px;vertical-align:middle"></td>
  <td style="padding:8px 12px;border:1px solid #cbd5e1;text-align:center">21.5%</td>
  <td style="padding:8px 12px;border:1px solid #cbd5e1;text-align:center"><strong>25.4%</strong></td>
  <td style="padding:8px 12px;border:1px solid #cbd5e1;text-align:center;color:#16a34a">+3.9pp</td>
</tr>
<tr style="background:#fafafa">
  <td style="padding:8px 12px;border:1px solid #cbd5e1">ラスターカノン</td>
  ...
  <td style="padding:8px 12px;border:1px solid #cbd5e1;text-align:center;color:#dc2626">-2.7pp</td>
</tr>
<tr>
  <td style="padding:8px 12px;border:1px solid #cbd5e1">きあいだま</td>
...
<tr>
  <td style="padding:8px 12px;border:1px solid #cbd5e1">だいちのちから</td>
...
<tr>
  ...
  <td style="padding:8px 12px;border:1px solid #cbd5e1">じゃれつく（フェアリー・採用率98.2%）が×4弱点。いのちのたま込みの一致技でスカーフ運用のサザンドラでも大ダメージを受け、あくのはどうはミミッキュ（ゴースト/フェアリー）に等倍止まりで打点も伸びません</td>
</tr>
<tr style="background:#fafafa">
  <td style="padding:8px 12px;border:1px solid #cbd5e1">
...
<tr>
  ...
  <td style="padding:8px 12px;border:1px solid #cbd5e1">インファイト（かくとう・採用率67.2%）が×2弱点。バシャーモ（ほのお/かくとう）はかえんほうしゃ・だいもんじを耐性（×0.5）で受けるため、火力技で押し切れません</td>
</tr>
<tr style="background:#fafafa">
  <td style="padding:8px 12px;border:1px solid #cbd5e1">
...
<tr>
  ...
  <td style="padding:8px 12px;border:1px solid #cbd5e1">れいとうビーム（こおり・採用率87.2%）が×2弱点。ゲッコウガ（みず/あく）はあくのはどうを耐性（×0.5）で受けつつ、れいとうビーム（×2）で反撃してくる相手です</td>
</tr>
</tbody>
</table>
</div>
