---
title: 'ウォッシュロトム考察 M-2 使用率22位 ボルトチェンジとおにびの起点作り'
description: 'チャンピオンズM-2使用率22位ウォッシュロトムを徹底解説。ハイドロポンプ採用率98.5%・ボルトチェンジ88.7%・おにび80.6%のサポート型から、ふゆうでじめん無効・弱点はくさ×2のみという優秀な耐性まで実データで解説。HD耐久型の立ち回りと苦手なポケモンの対策を紹介します。'
updatedDate: '2026-06-11'
pubDate: '2026-06-11'
draft: false
heroImage: '../../assets/hero-rotom-wash-m2.png'
---
