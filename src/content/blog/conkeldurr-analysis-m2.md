...
description: 'チャンピオンズM-2使用率61位ローブシンを徹底解説。A140の高火力とてつのこぶし（採用率62.1%）でドレインパンチ・マッハパンチを撃つ低速アタッカー。くろおび35.8%・きあいのタスキ27.6%・オボンのみ23.3%の持ち物分岐、こんじょう型の差分、かくとう単タイプの相性を実データで解説します。'
