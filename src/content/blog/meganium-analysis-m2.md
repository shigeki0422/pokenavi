---
title: '（メガ）メガニウム考察 M-2 使用率37位 メガソーラー＋ウェザーボールの晴れアタッカー'
description: 'チャンピオンズM-2使用率37位メガニウム（メガメガニウム）を徹底解説。メガニウムナイト採用率98.6%でメガ前提。特性メガソーラーで常時晴れ化し、ソーラービームを溜めなしで連射・ウェザーボールをほのお技として運用するくさ/フェアリーの特殊アタッカー。技採用率・型・苦手なポケモンを実データで解説。'
