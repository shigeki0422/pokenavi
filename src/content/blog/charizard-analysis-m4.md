...
heroImage: '../../assets/hero-charizard-m4.png'
draft: true
---
...
**性格差：Cの違いが決めるメガメタグロスへの削り量**

ひかえめはH155 / A111 / B98 / C232 / D135 / S152、おくびょうはH155 / A111 / B98 / C211 / D135 / S167です。メガメタグロス（はがね/エスパー、ほのお×2弱点、D実数値130）へかえんほうしゃを撃つ場合、ひかえめC232は185〜218ダメージ（119.6〜140.7%）、おくびょうC211は169〜199ダメージ（109.0〜128.3%）となり、どちらも確定1発は変わりませんが、乱数下限まで含めて安定して1発を通せるのはひかえめです。おくびょうはS167まで伸び、環境上位のサザンドラ（おくびょう最速個体でS165、スカーフ非採用時）を上から取れる代わりに、この削り量の余裕を手放す形になります。
...
<strong>EV:</strong> H2-A32-S32（メガX最多EV分布）<br>
...
**性格差：Sの違いが決めるミミッキュとの先手争い**

いじっぱりはH155 / A200 / B131 / C135 / D105 / S152、ようきはH155 / A182 / B131 / C135 / D105 / S167です。環境2位のミミッキュは性格の80.7%がいじっぱり（S補正なし・最速個体でS148）で、この多数派に対してはようきのS167・いじっぱりのS152のどちらも上から動けます。先後が分かれるのは性格採用率14.6%の少数派・ようきミミッキュ（最速個体でS162）に対してで、ようきのS167は上から取れますが、いじっぱりのS152は下回り後手に回ります。ミミッキュの主力技はつるぎのまい（採用率84.8%）から放つじゃれつく（フェアリー・98.2%）ですが、フェアリーはメガXのほのお複合に半減されるため一致ドラゴン弱点は相殺され実質等倍です。一方でA200のフレアドライブはA182より一撃の破壊力が高く、りゅうのまいで積んだ後の削り性能はいじっぱりの方が上回ります。少数派のようきミミッキュ相手にも先手を確保したい場合はようき、積んだ後の削り性能を優先するならいじっぱりという選択です。
