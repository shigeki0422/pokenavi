...
いじっぱりはH155 / A200 / B131 / C135 / D105 / S152、ようきはH155 / A182 / B131 / C135 / D105 / S167です。環境2位のミミッキュは性格の83.3%がいじっぱり（S補正なし・最速個体でS148）で、この多数派に対してはようきのS167・いじっぱりのS152のどちらも上から動けます。先後が分かれるのは性格採用率9.6%の少数派・ようきミミッキュ（最速個体でS162）に対してで、ようきのS167は上から取れますが、いじっぱりのS152は下回り後手に回ります。ミミッキュの主力技はつるぎのまい（採用率84.8%）から放つじゃれつく（フェアリー・98.2%）ですが、フェアリーはメガXのほのお複合に半減されるため一致ドラゴン弱点は相殺され実質等倍です。少数派のようきミミッキュ相手にも先手を確保したい場合はようき、積んだ後の削り性能を優先するならいじっぱりという選択です。一方でA200のフレアドライブはA182より一撃の破壊力が高く、りゅうのまいで積んだ後の削り性能はいじっぱりの方が上回ります。ミミッキュとの先手を優先するならようき、積んだ後の火力を優先するならいじっぱりという選択です。
