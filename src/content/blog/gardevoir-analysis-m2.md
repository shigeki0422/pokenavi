---
title: 'サーナイト考察 M-2 使用率54位 メガフェアリースキンのハイボ全体打点'
description: 'チャンピオンズM-2使用率54位メガサーナイトを徹底解説。メガ後フェアリースキンでハイパーボイス（採用率79.8%）がフェアリー一致打点に変わり、C238の超火力で環境上位を薙ぎ払う。しんくうは75.2%の先制・マジカルフレイム48.4%の構成、ひかえめ75.3%・CS振りの型と苦手な相手まで実データで解説します。'
