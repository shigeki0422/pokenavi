---
title: 'エルフーン考察 M-3 やどりぎ消耗型へシフトした採用率変化と立ち回り'
description: 'チャンピオンズM-3使用率47位エルフーンを徹底解説。アンコール59.6%・やどりぎのタネ42.9%など、M-2からの技採用率の変化をデータで解説。いたずらごころ補助型の型別構成・環境上位への相性・パーティ構成まで紹介します。'
