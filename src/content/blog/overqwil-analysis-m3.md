---
title: 'ハリーマン考察 M-3 型別採用率と立ち回り'
description: 'チャンピオンズM-3使用率105位ハリーマンを徹底解説。たべのこし46.5%の耐久型が主流で、どくばりセンボン62.8%・どくびし35.0%の毒まき構成と、ちいさくなる34.6%の回避積み型まで実データで解説。エスパー無効のあく/どく複合の活かし方を考察。'
