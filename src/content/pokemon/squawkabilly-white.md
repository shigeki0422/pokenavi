---
title: 'イキリンコ(ホワイト) | ポケモンチャンピオンズ 使用率・基礎データ'
description: 'ポケモンチャンピオンズのイキリンコ(ホワイト)基礎データ。種族値・タイプ相性・特性・覚える技を掲載。使用率圏外。'
pokemonName: 'イキリンコ(ホワイト)'
dexNumber: 931
usageRank: 999
imageForm: '03'
pubDate: '2026-05-24'
...
<div style="display:flex;align-items:center;gap:16px;margin:0 0 24px">
  <img src="/images/pokemon/pokemon-0931-03.webp" alt="イキリンコ(ホワイト)" style="width:96px;height:96px" loading="eager" />
  <div>
    <h1 style="margin:0 0 6px;font-size:1.6rem">イキリンコ(ホワイト)</h1>
