...
<div style="display:flex;align-items:center;gap:16px;margin:0 0 24px">
  <img src="/images/pokemon/pokemon-0128-01.webp" alt="ケンタロス（格）" style="width:96px;height:96px" loading="eager" />
  <div>
...
<div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(90px,1fr));gap:10px;margin:12px 0">
  ...
  <div style="text-align:center;padding:8px;border:1px solid #e2e8f0;border-radius:8px">
    <img src="/images/pokemon/pokemon-0503-00.webp" alt="ダイケンキ" style="width:56px;height:56px;display:block;margin:0 auto 4px" loading="lazy">
  ...
  <div style="text-align:center;padding:8px;border:1px solid #e2e8f0;border-radius:8px">
    <img src="/images/pokemon/pokemon-0683-00.webp" alt="フレフワン" style="width:56px;height:56px;display:block;margin:0 auto 4px" loading="lazy">
    <div style="font-size:0.72rem;font-weight:bold">フレフワン</div>
    <div style="font-size:0.68rem;color:#888">4位</div>
  </div>
  <div style="text-align:center;padding:8px;border:1px solid #e2e8f0;border-radius:8px">
    <img src="/images/pokemon/pokemon-0323-00.webp" alt="バクーダ" style="width:56px;height:56px;display:block;margin:0 auto 4px" loading="lazy">
    <div style="font-size:0.72rem;font-weight:bold">バクーダ</div>
    <div style="font-size:0.68rem;color:#888">5位</div>
  </div>
  <div style="text-align:center;padding:8px;border:1px solid #e2e8f0;border-radius:8px">
    <img src="/images/pokemon/pokemon-0569-00.webp" alt="ダストダス" style="width:56px;height:56px;display:block;margin:0 auto 4px" loading="lazy">
  ...
  <div style="text-align:center;padding:8px;border:1px solid #e2e8f0;border-radius:8px">
    <img src="/images/pokemon/pokemon-0706-00.webp" alt="ヌメルゴン" style="width:56px;height:56px;display:block;margin:0 auto 4px" loading="lazy">
