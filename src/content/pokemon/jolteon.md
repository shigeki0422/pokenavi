...
description: 'ポケモンチャンピオンズのサンダース基礎データ。種族値・タイプ相性・特性と、技・持ち物・性格・チームメイトの使用率TOP10を掲載。使用率圏外。'
pokemonName: 'サンダース'
dexNumber: 135
usageRank: 999
...
faq:
  season: 'M-5'
  topMoves: ['10まんボルト', 'みわくのボイス', 'シャドーボール', 'ボルトチェンジ']
  topMovePct: [74.6, 61.3, 52.6, 49.6]
  topItems: ['きあいのタスキ', 'いのちのたま', 'じしゃく']
  topItemPct: [31.1, 18.7, 14.2]
  topAbility: 'ちくでん'
  topAbilityPct: 83.2
  topNature: 'おくびょう'
  topNaturePct: 67.4
...
<div style="display:flex;align-items:center;gap:16px;margin:0 0 24px">
  ...
  <div>
    ...
    <div style="font-size:0.85rem;color:#555">
      全国図鑑 <strong>No.135</strong>　／　使用率 <strong style="color:#dc2626">圏外</strong>
    </div>
