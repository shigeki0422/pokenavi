---
title: 'ダストダス | ポケモンチャンピオンズ 使用率・基礎データ M-2'
description: 'ポケモンチャンピオンズ M-2シーズンのダストダス基礎データ。種族値・タイプ相性・特性と、技・持ち物・性格・チームメイトの使用率TOP10を掲載。使用率190位。'
pokemonName: 'ダストダス'
dexNumber: 569
usageRank: 190
pubDate: '2026-05-24'
...
<div style="display:flex;align-items:center;gap:16px;margin:0 0 24px">
  <img src="/images/pokemon/pokemon-0569-00.webp" alt="ダストダス" style="width:96px;height:96px" />
  <div>
    ...
    <div style="font-size:0.85rem;color:#555">
      全国図鑑 <strong>No.569</strong>　／　M-2 使用率 <strong style="color:#dc2626">190位</strong>
    </div>
...
<tr style="background:#fef9c3">
  ...
  <td style="padding:8px 12px;border:1px solid #cbd5e1;font-weight:bold"><div style="display:flex;align-items:center;gap:6px"><img src="/images/types/type-00-normal.png" alt="ノーマル" style="width:20px;height:20px"> だいばくはつ</div></td>
  <td style="padding:8px 12px;border:1px solid #cbd5e1;text-align:center;font-weight:bold">72.9%</td>
</tr>
<tr>
...
<tr style="background:#fef9c3">
  ...
  <td style="padding:8px 12px;border:1px solid #cbd5e1;text-align:center;font-weight:bold">29.7%</td>
</tr>
<tr>
  <td style="padding:8px 12px;border:1px solid #cbd5e1;text-align:center;">2</td>
...
<tr>
  <td style="padding:8px 12px;border:1px solid #cbd5e1;text-align:center;">8</td>
  <td style="padding:8px 12px;border:1px solid #cbd5e1;"><div style="display:flex;align-items:center;gap:6px"><span style="display:inline-block;width:24px;height:24px;background-image:url('/images/items/item-sprite.png');background-size:480px 648px;background-position:-240px -24px;flex-shrink:0"></span>ウタンのみ</div></td>
...
<tr style="background:#fef9c3">
  ...
  <td style="padding:8px 12px;border:1px solid #cbd5e1;text-align:center;font-weight:bold">33.9%</td>
</tr>
<tr>
  <td style="padding:8px 12px;border:1px solid #cbd5e1;text-align:center;">2</td>
...
<tr style="background:#fef9c3">
  ...
  <td style="padding:8px 10px;border:1px solid #cbd5e1;text-align:center">30</td><td style="padding:8px 10px;border:1px solid #cbd5e1;text-align:center;color:#aaa">0</td><td style="padding:8px 10px;border:1px solid #cbd5e1;text-align:center">28</td><td style="padding:8px 10px;border:1px solid #cbd5e1;text-align:center;color:#aaa">0</td><td style="padding:8px 10px;border:1px solid #cbd5e1;text-align:center;color:#aaa">0</td><td style="padding:8px 10px;border:1px solid #cbd5e1;text-align:center;color:#aaa">0</td>
  <td style="padding:8px 10px;border:1px solid #cbd5e1;text-align:center;font-weight:bold">15.8%</td>
</tr>
<tr>
