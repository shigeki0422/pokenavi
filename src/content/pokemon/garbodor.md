...
description: 'ポケモンチャンピオンズのダストダス基礎データ。種族値・タイプ相性・特性・覚える技を掲載。使用率圏外。'
pokemonName: 'ダストダス'
dexNumber: 569
usageRank: 999
pubDate: '2026-05-24'
...
<tr style="background:#fafafa">
  ...
  <td class="pn-hover-name" style="padding:8px 12px;border:1px solid #cbd5e1">くだけるよろい</td>
...
<tr>
  ...
  <td class="pn-hover-name" style="padding:8px 12px;border:1px solid #cbd5e1">ゆうばく</td>
...
<tr style="background:#fafafa">
  ...
  <td class="pn-hover-name" style="padding:8px 12px;border:1px solid #cbd5e1">あくしゅう</td>
