---
title: 'フラージェス | ポケモンチャンピオンズ 使用率・基礎データ M-2'
description: 'ポケモンチャンピオンズ M-2シーズンのフラージェス基礎データ。種族値・タイプ相性・特性と、技・持ち物・性格・チームメイトの使用率TOP10を掲載。使用率170位。'
pokemonName: 'フラージェス'
dexNumber: 671
usageRank: 170
pubDate: '2026-05-24'
...
<div style="display:flex;align-items:center;gap:16px;margin:0 0 24px">
  <img src="/images/pokemon/pokemon-0671-00.webp" alt="フラージェス" style="width:96px;height:96px" />
  <div>
    ...
    <div style="font-size:0.85rem;color:#555">
      全国図鑑 <strong>No.671</strong>　／　M-2 使用率 <strong style="color:#dc2626">170位</strong>
    </div>
...
<tr style="background:#fafafa">
  ...
  <td style="padding:8px 12px;border:1px solid #cbd5e1;text-align:center;">62.8%</td>
</tr>
<tr>
...
<tr style="background:#fef9c3">
  ...
  <td style="padding:8px 12px;border:1px solid #cbd5e1;text-align:center;font-weight:bold">50.7%</td>
</tr>
<tr>
  <td style="padding:8px 12px;border:1px solid #cbd5e1;text-align:center;">2</td>
...
<tr style="background:#fef9c3">
  ...
  <td style="padding:8px 10px;border:1px solid #cbd5e1;text-align:center;font-weight:bold">11.0%</td>
</tr>
<tr>
