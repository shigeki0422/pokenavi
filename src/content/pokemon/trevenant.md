...
description: 'ポケモンチャンピオンズのオーロット基礎データ。種族値・タイプ相性・特性・覚える技を掲載。使用率圏外。'
pokemonName: 'オーロット'
dexNumber: 709
usageRank: 999
pubDate: '2026-05-24'
...
<div style="display:flex;align-items:center;gap:16px;margin:0 0 24px">
  ...
  <div>
    ...
    <div style="font-size:0.85rem;color:#555">
      全国図鑑 <strong>No.709</strong>　／　使用率 <strong style="color:#dc2626">圏外</strong>
    </div>
...
<tr style="background:#fafafa">
  ...
  <td class="pn-hover-name" style="padding:8px 12px;border:1px solid #cbd5e1">しゅうかく</td>
  <td style="padding:6px 12px;border:1px solid #cbd5e1"><div class="pn-rate-wrap"><div style="padding:2px 0;color:#94a3b8">—</div><div class="pn-popup"><div style="max-width:260px;white-space:normal;line-height:1.5">使ったきのみをターン終わりに50%（にほんばれ中は必ず）作り出す。</div></div></div></td>
</tr>
<tr>
...
<tr style="background:#fafafa">
  ...
  <td class="pn-hover-name" style="padding:8px 12px;border:1px solid #cbd5e1">しぜんかいふく</td>
  <td style="padding:6px 12px;border:1px solid #cbd5e1"><div class="pn-rate-wrap"><div style="padding:2px 0;color:#94a3b8">—</div><div class="pn-popup"><div style="max-width:260px;white-space:normal;line-height:1.5">手持ちに戻ると状態異常が治る。</div></div></div></td>
</tr>
</tbody>
</table>
</div>
