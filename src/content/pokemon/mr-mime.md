---
title: 'バリヤード | ポケモンチャンピオンズ 使用率・基礎データ'
description: 'ポケモンチャンピオンズのバリヤード基礎データ。種族値・タイプ相性・特性・覚える技を掲載。使用率圏外。'
pokemonName: 'バリヤード'
dexNumber: 122
usageRank: 999
pubDate: '2026-05-24'
...
<div style="display:flex;align-items:center;gap:16px;margin:0 0 24px">
  <img src="/images/pokemon/pokemon-0122-00.webp" alt="バリヤード" style="width:96px;height:96px" loading="eager" />
  <div>
    <h1 style="margin:0 0 6px;font-size:1.6rem">バリヤード</h1>
    ...
    <div style="font-size:0.85rem;color:#555">
      全国図鑑 <strong>No.122</strong>　／　使用率 <strong style="color:#dc2626">圏外</strong>
    </div>
...
<tr style="background:#fafafa">
  ...
  <td style="padding:6px 12px;border:1px solid #cbd5e1"><div class="pn-rate-wrap"><div style="padding:2px 0;color:#94a3b8">—</div><div class="pn-popup"><div style="max-width:260px;white-space:normal;line-height:1.5">音の技が効かない。</div></div></div></td>
</tr>
<tr>
  <td style="padding:8px 12px;border:1px solid #cbd5e1;text-align:center">2</td>
  <td class="pn-hover-name" style="padding:8px 12px;border:1px solid #cbd5e1">フィルター</td>
  <td style="padding:6px 12px;border:1px solid #cbd5e1"><div class="pn-rate-wrap"><div style="padding:2px 0;color:#94a3b8">—</div><div class="pn-popup"><div style="max-width:260px;white-space:normal;line-height:1.5">効果バツグンの技で受けるダメージを3/4にする。</div></div></div></td>
</tr>
<tr style="background:#fafafa">
  ...
  <td style="padding:6px 12px;border:1px solid #cbd5e1"><div class="pn-rate-wrap"><div style="padding:2px 0;color:#94a3b8">—</div><div class="pn-popup"><div style="max-width:260px;white-space:normal;line-height:1.5">威力が60以下の技の威力が1.5倍になる。</div></div></div></td>
</tr>
</tbody>
</table>
</div>
