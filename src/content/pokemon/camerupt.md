...
description: 'ポケモンチャンピオンズのバクーダ基礎データ。種族値・タイプ相性・特性・覚える技を掲載。使用率圏外。'
pokemonName: 'バクーダ'
dexNumber: 323
usageRank: 999
pubDate: '2026-09-10'
...
<tr style="background:#fef9c3">
  ...
  <td class="pn-hover-name" style="padding:8px 12px;border:1px solid #cbd5e1;font-weight:bold">ハードロック</td>
...
<tr style="background:#fef9c3">
  <td style="padding:8px 12px;border:1px solid #cbd5e1;text-align:center;font-weight:bold">1</td>
  <td class="pn-hover-name" style="padding:8px 12px;border:1px solid #cbd5e1;font-weight:bold"><div style="display:flex;align-items:center;gap:6px"><img src="/images/types/type-00-normal.png" alt="ノーマル" style="width:20px;height:20px"> あくび</div></td>
...
<tr style="background:#fafafa">
  ...
  <td class="pn-hover-name" style="padding:8px 12px;border:1px solid #cbd5e1;"><div style="display:flex;align-items:center;gap:6px"><img src="/images/types/type-09-fire.png" alt="ほのお" style="width:20px;height:20px"> だいもんじ</div></td>
...
<tr style="background:#fafafa">
  ...
  <td class="pn-hover-name" style="padding:8px 12px;border:1px solid #cbd5e1;"><div style="display:flex;align-items:center;gap:6px"><img src="/images/types/type-00-normal.png" alt="ノーマル" style="width:20px;height:20px"> じばく</div></td>
...
<tr style="background:#fef9c3">
  ...
  <td style="padding:6px 10px;border:1px solid #cbd5e1"><div style="padding:2px 0"><div style="display:flex;align-items:center;gap:4px"><div style="position:relative;flex:1;min-width:0;background:#e2e8f0;border-radius:3px;height:20px;overflow:hidden"><div style="position:absolute;inset:0;background:#bfdbfe;width:83.3%"></div><span style="position:relative;z-index:1;font-weight:600;font-size:0.88em;padding:0 6px;line-height:20px;white-space:nowrap">83.3%</span></div><span style="width:40px;flex-shrink:0;text-align:right"></span></div></div></td>
</tr>
<tr>
