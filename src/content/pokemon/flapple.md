...
description: 'ポケモンチャンピオンズのアップリュー基礎データ。種族値・タイプ相性・特性と、技・持ち物・性格・チームメイトの使用率TOP10を掲載。使用率195位。'
pokemonName: 'アップリュー'
dexNumber: 841
usageRank: 195
pubDate: '2026-06-18'
...
<div style="display:flex;align-items:center;gap:16px;margin:0 0 24px">
  ...
  <div>
    ...
    <div style="font-size:0.85rem;color:#555">
      全国図鑑 <strong>No.841</strong>　／　使用率 <strong style="color:#dc2626">195位</strong>
    </div>
...
<tr>
  ...
  <td style="padding:8px 12px;border:1px solid #cbd5e1;"><div style="display:flex;align-items:center">ルガルガン(昼)</div></td>
  <td style="padding:6px 12px;border:1px solid #cbd5e1"><div style="padding:2px 0;color:#94a3b8;font-size:0.85em">—</div></td>
</tr>
<tr style="background:#fafafa">
