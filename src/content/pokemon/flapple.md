...
<tr style="background:#fef9c3">
  ...
  <td style="padding:6px 12px;border:1px solid #cbd5e1"><div class="pn-rate-wrap"><div style="position:relative;background:#e2e8f0;border-radius:3px;height:20px;overflow:hidden;padding:2px 0"><div style="position:absolute;inset:0;background:#bfdbfe;width:98.0%"></div><span style="position:relative;z-index:1;font-weight:600;font-size:0.88em;padding:0 6px;line-height:20px;white-space:nowrap">98.0%</span></div><div class="pn-popup"><div style="max-width:260px;white-space:normal;line-height:1.5;margin-bottom:0px">攻撃技の威力が1.3倍になるが、攻撃のたびに最大HPの1/10の反動を受ける。</div></div></div></td>
</tr>
<tr>
  <td style="padding:8px 12px;border:1px solid #cbd5e1;text-align:center;">2</td>
...
<tr style="background:#fef9c3">
  ...
  <td style="padding:6px 12px;border:1px solid #cbd5e1"><div style="padding:2px 0"><div style="position:relative;background:#e2e8f0;border-radius:3px;height:20px;overflow:hidden;padding:2px 0"><div style="position:absolute;inset:0;background:#bfdbfe;width:98.0%"></div><span style="position:relative;z-index:1;font-weight:600;font-size:0.88em;padding:0 6px;line-height:20px;white-space:nowrap">98.0%</span></div></div></td>
</tr>
<tr>
  <td style="padding:8px 12px;border:1px solid #cbd5e1;text-align:center;">2</td>
...
<tr style="background:#fef9c3">
  ...
  <td style="padding:6px 10px;border:1px solid #cbd5e1"><div style="padding:2px 0"><div style="position:relative;background:#e2e8f0;border-radius:3px;height:20px;overflow:hidden;padding:2px 0"><div style="position:absolute;inset:0;background:#bfdbfe;width:98.0%"></div><span style="position:relative;z-index:1;font-weight:600;font-size:0.88em;padding:0 6px;line-height:20px;white-space:nowrap">98.0%</span></div></div></td>
</tr>
<tr>
