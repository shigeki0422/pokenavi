---
title: 'ポットデス | ポケモンチャンピオンズ 使用率・基礎データ M-2'
description: 'ポケモンチャンピオンズ M-2シーズンのポットデス基礎データ。種族値・タイプ相性・特性と、技・持ち物・性格・チームメイトの使用率TOP10を掲載。使用率62位。'
pokemonName: 'ポットデス'
dexNumber: 855
usageRank: 62
pubDate: '2026-05-24'
...
<div style="display:flex;align-items:center;gap:16px;margin:0 0 24px">
  ...
  <div>
    ...
    <div style="font-size:0.85rem;color:#555">
      全国図鑑 <strong>No.855</strong>　／　M-2 使用率 <strong style="color:#dc2626">62位</strong>
    </div>
...
<tr>
  ...
  <td style="padding:8px 12px;border:1px solid #cbd5e1;text-align:center;">90.3%</td>
</tr>
<tr style="background:#fafafa">
  ...
  <td style="padding:8px 12px;border:1px solid #cbd5e1;text-align:center;">88.4%</td>
</tr>
<tr>
  ...
  <td style="padding:8px 12px;border:1px solid #cbd5e1;text-align:center;">80.0%</td>
</tr>
<tr style="background:#fafafa">
...
<tr style="background:#fef9c3">
  ...
  <td style="padding:8px 12px;border:1px solid #cbd5e1;text-align:center;font-weight:bold">70.2%</td>
</tr>
<tr>
  <td style="padding:8px 12px;border:1px solid #cbd5e1;text-align:center;">2</td>
...
<tr style="background:#fef9c3">
  ...
  <td style="padding:8px 10px;border:1px solid #cbd5e1;text-align:center;font-weight:bold">38.6%</td>
</tr>
<tr>
...
<tr style="background:#fafafa">
  ...
  <td style="padding:8px 10px;border:1px solid #cbd5e1;text-align:center">23</td><td style="padding:8px 10px;border:1px solid #cbd5e1;text-align:center;color:#aaa">0</td><td style="padding:8px 10px;border:1px solid #cbd5e1;text-align:center">25</td><td style="padding:8px 10px;border:1px solid #cbd5e1;text-align:center;color:#aaa">0</td><td style="padding:8px 10px;border:1px solid #cbd5e1;text-align:center;color:#aaa">0</td><td style="padding:8px 10px;border:1px solid #cbd5e1;text-align:center">18</td>
...
<div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(90px,1fr));gap:10px;margin:12px 0">
  <div style="text-align:center;padding:8px;border:1px solid #e2e8f0;border-radius:8px">
    <img src="/images/pokemon/pokemon-0530-00.webp" alt="ドリュウズ" style="width:56px;height:56px;display:block;margin:0 auto 4px" loading="lazy">
    <div style="font-size:0.72rem;font-weight:bold">ドリュウズ</div>
    <div style="font-size:0.68rem;color:#888">1位</div>
  </div>
  <div style="text-align:center;padding:8px;border:1px solid #e2e8f0;border-radius:8px">
    <img src="/images/pokemon/pokemon-0354-00.webp" alt="ジュペッタ" style="width:56px;height:56px;display:block;margin:0 auto 4px" loading="lazy">
    <div style="font-size:0.72rem;font-weight:bold">ジュペッタ</div>
  ...
  <div style="text-align:center;padding:8px;border:1px solid #e2e8f0;border-radius:8px">
    <img src="/images/pokemon/pokemon-0959-00.webp" alt="デカヌチャン" style="width:56px;height:56px;display:block;margin:0 auto 4px" loading="lazy">
    <div style="font-size:0.72rem;font-weight:bold">デカヌチャン</div>
