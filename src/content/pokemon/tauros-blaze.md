...
description: 'ポケモンチャンピオンズのケンタロス（炎）基礎データ。種族値・タイプ相性・特性と、技・持ち物・性格・チームメイトの使用率TOP10を掲載。使用率131位。'
pokemonName: 'ケンタロス（炎）'
dexNumber: 128
usageRank: 131
imageForm: '02'
...
<div style="display:flex;align-items:center;gap:16px;margin:0 0 24px">
  ...
  <div>
    ...
    <div style="font-size:0.85rem;color:#555">
      全国図鑑 <strong>No.128</strong>　／　使用率 <strong style="color:#dc2626">131位</strong>
    </div>
