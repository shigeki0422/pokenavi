...
description: 'ポケモンチャンピオンズのムシャーナ基礎データ。種族値・タイプ相性・特性・覚える技を掲載。使用率圏外。'
pokemonName: 'ムシャーナ'
dexNumber: 518
usageRank: 999
pubDate: '2026-09-10'
...
<div style="display:flex;align-items:center;gap:16px;margin:0 0 24px">
  ...
  <div>
    ...
    <div style="font-size:0.85rem;color:#555">
      全国図鑑 <strong>No.518</strong>　／　使用率 <strong style="color:#dc2626">圏外</strong>
    </div>
...
<tr style="background:#fef9c3">
  ...
  <td class="pn-hover-name" style="padding:8px 12px;border:1px solid #cbd5e1;font-weight:bold">シンクロ</td>
...
<tr style="background:#fef9c3">
  <td style="padding:8px 12px;border:1px solid #cbd5e1;text-align:center;font-weight:bold">1</td>
  <td class="pn-hover-name" style="padding:8px 12px;border:1px solid #cbd5e1;font-weight:bold"><div style="display:flex;align-items:center;gap:6px"><img src="/images/types/type-13-psychic.png" alt="エスパー" style="width:20px;height:20px"> いやしのねがい</div></td>
...
<tr style="background:#fafafa">
  ...
  <td class="pn-hover-name" style="padding:8px 12px;border:1px solid #cbd5e1;"><div style="display:flex;align-items:center;gap:6px"><img src="/images/types/type-17-fairy.png" alt="フェアリー" style="width:20px;height:20px"> ムーンフォース</div></td>
...
<tr style="background:#fafafa">
  ...
  <td class="pn-hover-name" style="padding:8px 12px;border:1px solid #cbd5e1;"><div style="display:flex;align-items:center;gap:6px"><img src="/images/types/type-17-fairy.png" alt="フェアリー" style="width:20px;height:20px"> ミストバースト</div></td>
