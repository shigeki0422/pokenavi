---
title: 'バイバニラ | ポケモンチャンピオンズ 使用率・基礎データ M-2'
description: 'ポケモンチャンピオンズ M-2シーズンのバイバニラ基礎データ。種族値・タイプ相性・特性と、技・持ち物・性格・チームメイトの使用率TOP10を掲載。使用率50位。'
pokemonName: 'バイバニラ'
dexNumber: 584
usageRank: 50
pubDate: '2026-05-24'
...
<div style="display:flex;align-items:center;gap:16px;margin:0 0 24px">
  <img src="/images/pokemon/pokemon-0584-00.webp" alt="バイバニラ" style="width:96px;height:96px" />
  <div>
    ...
    <div style="font-size:0.85rem;color:#555">
      全国図鑑 <strong>No.584</strong>　／　M-2 使用率 <strong style="color:#dc2626">50位</strong>
    </div>
...
<tr>
  ...
  <td style="padding:8px 12px;border:1px solid #cbd5e1;text-align:center;">94.1%</td>
</tr>
<tr style="background:#fafafa">
