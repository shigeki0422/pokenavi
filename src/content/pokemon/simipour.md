...
description: 'ポケモンチャンピオンズのヒヤッキー基礎データ。種族値・タイプ相性・特性・覚える技を掲載。使用率圏外。'
pokemonName: 'ヒヤッキー'
dexNumber: 516
usageRank: 999
pubDate: '2026-05-24'
...
<tr style="background:#fafafa">
  ...
  <td style="padding:6px 12px;border:1px solid #cbd5e1"><div class="pn-rate-wrap"><div style="padding:2px 0;color:#94a3b8">—</div><div class="pn-popup"><div style="max-width:260px;white-space:normal;line-height:1.5">HPが最大HPの1/3以下になると、みずタイプの技の威力が1.5倍になる。</div></div></div></td>
</tr>
<tr>
