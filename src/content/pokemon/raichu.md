---
title: 'ライチュウ | ポケモンチャンピオンズ 使用率・基礎データ M-2'
description: 'ポケモンチャンピオンズ M-2シーズンのライチュウ基礎データ。種族値・タイプ相性・特性と、技・持ち物・性格・チームメイトの使用率TOP10を掲載。使用率187位。'
pokemonName: 'ライチュウ'
dexNumber: 26
usageRank: 187
pubDate: '2026-05-24'
...
<div style="display:flex;align-items:center;gap:16px;margin:0 0 24px">
  <img src="/images/pokemon/pokemon-0026-00.webp" alt="ライチュウ" style="width:96px;height:96px" />
  <div>
    ...
    <div style="font-size:0.85rem;color:#555">
      全国図鑑 <strong>No.26</strong>　／　M-2 使用率 <strong style="color:#dc2626">187位</strong>
    </div>
...
<tr style="background:#fef9c3">
  ...
  <td style="padding:8px 12px;border:1px solid #cbd5e1;text-align:center;font-weight:bold">63.0%</td>
</tr>
<tr>
