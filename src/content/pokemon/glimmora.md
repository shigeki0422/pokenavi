---
title: 'キラフロル | ポケモンチャンピオンズ 使用率・基礎データ M-2'
description: 'ポケモンチャンピオンズ M-2シーズンのキラフロル基礎データ。種族値・タイプ相性・特性と、技・持ち物・性格・チームメイトの使用率TOP10を掲載。使用率14位。'
pokemonName: 'キラフロル'
dexNumber: 970
usageRank: 14
pubDate: '2026-05-24'
...
<div style="display:flex;align-items:center;gap:16px;margin:0 0 24px">
  <img src="/images/pokemon/pokemon-0970-00.webp" alt="キラフロル" style="width:96px;height:96px" />
  <div>
    ...
    <div style="font-size:0.85rem;color:#555">
      全国図鑑 <strong>No.970</strong>　／　M-2 使用率 <strong style="color:#dc2626">14位</strong>
    </div>
...
<tr style="background:#fef9c3">
  ...
  <td style="padding:8px 12px;border:1px solid #cbd5e1;color:#555">物理技のダメージを受けると相手の場をどくびし状態にする。</td>
...
<tr>
  ...
  <td style="padding:8px 12px;border:1px solid #cbd5e1;text-align:center;">69.4%</td>
</tr>
...
<tr>
  ...
  <td style="padding:8px 12px;border:1px solid #cbd5e1;"><div style="display:flex;align-items:center;gap:6px"><img src="/images/types/type-05-rock.png" alt="いわ" style="width:20px;height:20px"> ロックカット</div></td>
...
<tr>
  ...
  <td style="padding:8px 10px;border:1px solid #cbd5e1;text-align:center;">18.5%</td>
</tr>
<tr style="background:#fafafa">
