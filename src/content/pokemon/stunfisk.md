---
title: 'マッギョ | ポケモンチャンピオンズ 使用率・基礎データ M-2'
description: 'ポケモンチャンピオンズ M-2シーズンのマッギョ基礎データ。種族値・タイプ相性・特性と、技・持ち物・性格・チームメイトの使用率TOP10を掲載。使用率173位。'
pokemonName: 'マッギョ'
dexNumber: 618
usageRank: 173
pubDate: '2026-05-24'
...
<div style="display:flex;align-items:center;gap:16px;margin:0 0 24px">
  <img src="/images/pokemon/pokemon-0618-00.webp" alt="マッギョ" style="width:96px;height:96px" />
  <div>
    ...
    <div style="font-size:0.85rem;color:#555">
      全国図鑑 <strong>No.618</strong>　／　M-2 使用率 <strong style="color:#dc2626">173位</strong>
    </div>
