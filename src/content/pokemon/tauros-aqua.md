...
description: 'ポケモンチャンピオンズのケンタロス（水）基礎データ。種族値・タイプ相性・特性・覚える技を掲載。使用率圏外。'
pokemonName: 'ケンタロス（水）'
dexNumber: 128
usageRank: 999
imageForm: '03'
...
<tr>
  ...
  <td style="padding:6px 12px;border:1px solid #cbd5e1"><div class="pn-rate-wrap"><div style="padding:2px 0;color:#94a3b8">—</div><div class="pn-popup"><div style="max-width:260px;white-space:normal;line-height:1.5">相手の攻撃が急所に当たると、自分の攻撃が6段階目まで上がる。</div></div></div></td>
</tr>
<tr style="background:#fafafa">
  ...
  <td style="padding:6px 12px;border:1px solid #cbd5e1"><div class="pn-rate-wrap"><div style="padding:2px 0;color:#94a3b8">—</div><div class="pn-popup"><div style="max-width:260px;white-space:normal;line-height:1.5">きのみを食べた次のターン終わりに、また同じきのみを1度だけ食べる。</div></div></div></td>
</tr>
</tbody>
</table>
</div>
