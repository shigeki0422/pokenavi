---
title: 'ゴーゴート | ポケモンチャンピオンズ 使用率・基礎データ'
description: 'ポケモンチャンピオンズのゴーゴート基礎データ。種族値・タイプ相性・特性・覚える技を掲載。使用率圏外。'
pokemonName: 'ゴーゴート'
dexNumber: 673
usageRank: 999
pubDate: '2026-05-24'
...
<div style="display:flex;align-items:center;gap:16px;margin:0 0 24px">
  <img src="/images/pokemon/pokemon-0673-00.webp" alt="ゴーゴート" style="width:96px;height:96px" loading="eager" />
  <div>
    <h1 style="margin:0 0 6px;font-size:1.6rem">ゴーゴート</h1>
    <div style="display:flex;align-items:center;gap:6px;margin-bottom:6px">
      <img src="/images/types/type-11-grass.png" alt="くさ" style="width:40px;height:40px;vertical-align:middle" />
    </div>
    <div style="font-size:0.85rem;color:#555">
      全国図鑑 <strong>No.673</strong>　／　使用率 <strong style="color:#dc2626">圏外</strong>
    </div>
...
<div style="max-width:560px;margin:16px 0;font-size:0.9em">
  ...
  <div style="display:flex;align-items:center;gap:8px;padding:8px 0;font-weight:700">
    ...
    <span style="min-width:40px;text-align:right;color:#2563eb;white-space:nowrap">531</span>
  </div>
</div>
...
<tr>
  ...
  <td class="pn-hover-name" style="padding:8px 12px;border:1px solid #cbd5e1">くさのけがわ</td>
  <td style="padding:6px 12px;border:1px solid #cbd5e1"><div class="pn-rate-wrap"><div style="padding:2px 0;color:#94a3b8">—</div><div class="pn-popup"><div style="max-width:260px;white-space:normal;line-height:1.5">グラスフィールド状態の時、防御が1.5倍になる。</div></div></div></td>
</tr>
</tbody>
</table>
</div>
