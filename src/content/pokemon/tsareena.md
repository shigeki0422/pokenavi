---
title: 'アマージョ | ポケモンチャンピオンズ 使用率・基礎データ M-2'
description: 'ポケモンチャンピオンズ M-2シーズンのアマージョ基礎データ。種族値・タイプ相性・特性と、技・持ち物・性格・チームメイトの使用率TOP10を掲載。使用率127位。'
pokemonName: 'アマージョ'
dexNumber: 763
usageRank: 127
pubDate: '2026-05-24'
...
<div style="display:flex;align-items:center;gap:16px;margin:0 0 24px">
  <img src="/images/pokemon/pokemon-0763-00.webp" alt="アマージョ" style="width:96px;height:96px" />
  <div>
    ...
    <div style="font-size:0.85rem;color:#555">
      全国図鑑 <strong>No.763</strong>　／　M-2 使用率 <strong style="color:#dc2626">127位</strong>
    </div>
...
<tr style="background:#fef9c3">
  ...
  <td style="padding:8px 12px;border:1px solid #cbd5e1;color:#555">自分と味方に対し、相手は先制技を使えない。</td>
  <td style="padding:8px 12px;border:1px solid #cbd5e1;text-align:center;font-weight:bold">83.1%</td>
</tr>
<tr>
...
<tr style="background:#fafafa">
  ...
  <td style="padding:8px 12px;border:1px solid #cbd5e1;color:#555">にほんばれ状態の時、状態異常にならない。</td>
...
<tr style="background:#fef9c3">
  ...
  <td style="padding:8px 12px;border:1px solid #cbd5e1;text-align:center;font-weight:bold">19.8%</td>
</tr>
<tr>
  <td style="padding:8px 12px;border:1px solid #cbd5e1;text-align:center;">2</td>
...
<tr style="background:#fef9c3">
  ...
  <td style="padding:8px 10px;border:1px solid #cbd5e1;text-align:center;font-weight:bold">36.3%</td>
</tr>
<tr>
...
<tr style="background:#fafafa">
  ...
  <td style="padding:8px 10px;border:1px solid #cbd5e1;text-align:center;">7.8%</td>
</tr>
<tr>
...
<div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(90px,1fr));gap:10px;margin:12px 0">
  <div style="text-align:center;padding:8px;border:1px solid #e2e8f0;border-radius:8px">
    <img src="/images/pokemon/pokemon-0324-00.webp" alt="コータス" style="width:56px;height:56px;display:block;margin:0 auto 4px">
    <div style="font-size:0.72rem;font-weight:bold">コータス</div>
    <div style="font-size:0.68rem;color:#888">1位</div>
  </div>
  <div style="text-align:center;padding:8px;border:1px solid #e2e8f0;border-radius:8px">
    <img src="/images/pokemon/pokemon-0205-00.webp" alt="フォレトス" style="width:56px;height:56px;display:block;margin:0 auto 4px">
    <div style="font-size:0.72rem;font-weight:bold">フォレトス</div>
