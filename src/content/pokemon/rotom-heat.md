---
title: 'ヒートロトム | ポケモンチャンピオンズ 使用率・基礎データ M-2'
...
<div style="display:flex;align-items:center;gap:16px;margin:0 0 24px">
  <img src="/images/pokemon/pokemon-0479-01.webp" alt="ヒートロトム" style="width:96px;height:96px" />
  <div>
    ...
    <div style="font-size:0.85rem;color:#555">
      全国図鑑 <strong>No.479</strong>　／　M-2 使用率 <strong style="color:#dc2626">49位</strong>
    </div>
...
<tr style="background:#fafafa">
  ...
  <td style="padding:8px 12px;border:1px solid #cbd5e1;text-align:center;">70.4%</td>
</tr>
<tr>
...
<tr style="background:#fef9c3">
  ...
  <td style="padding:8px 10px;border:1px solid #cbd5e1;text-align:center;font-weight:bold">20.6%</td>
</tr>
<tr>
