...
description: 'ポケモンチャンピオンズのヒートロトム基礎データ。種族値・タイプ相性・特性と、技・持ち物・性格・チームメイトの使用率TOP10を掲載。使用率49位。'
pokemonName: 'ヒートロトム'
dexNumber: 479
usageRank: 49
imageForm: '01'
...
<div style="display:flex;align-items:center;gap:16px;margin:0 0 24px">
  ...
  <div>
    ...
    <div style="font-size:0.85rem;color:#555">
      全国図鑑 <strong>No.479</strong>　／　使用率 <strong style="color:#dc2626">49位</strong>
    </div>
...
<tr style="background:#fef9c3">
  ...
  <td style="padding:6px 12px;border:1px solid #cbd5e1;min-width:160px"><div style="padding:2px 0"><div style="display:flex;align-items:center;gap:6px;padding:2px 0"><div style="flex:1;background:#e2e8f0;border-radius:3px;height:16px;overflow:hidden"><div style="background:#3b82f6;height:100%;width:40.8%"></div></div><span style="width:52px;text-align:right;font-weight:600;font-size:0.9em;flex-shrink:0">40.8%</span><span style="width:40px;flex-shrink:0"></span></div></div></td>
</tr>
<tr>
  <td style="padding:8px 12px;border:1px solid #cbd5e1;text-align:center;">2</td>
...
<tr style="background:#fef9c3">
  ...
  <td style="padding:6px 10px;border:1px solid #cbd5e1;min-width:160px"><div style="padding:2px 0"><div style="display:flex;align-items:center;gap:6px;padding:2px 0"><div style="flex:1;background:#e2e8f0;border-radius:3px;height:16px;overflow:hidden"><div style="background:#3b82f6;height:100%;width:21.3%"></div></div><span style="width:52px;text-align:right;font-weight:600;font-size:0.9em;flex-shrink:0">21.3%</span><span style="width:40px;flex-shrink:0"></span></div></div></td>
</tr>
<tr>
